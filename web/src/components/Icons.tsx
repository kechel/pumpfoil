...
// Systemarchitektur: gestapelte Server-Einheiten (Server/Stack/DB).
...
// Instagram — abgerundetes Quadrat + Linse + Blitz-Punkt (fill=currentColor für Tint-Nutzung).
...
// TikTok — Note (fill=currentColor).
export const TikTokIcon = ({ className = base }: P) => (
