...
const ENTRIES: Entry[] = [
  {
    ...
    items: [
      ...
      "On Garmin this is already live: version 1.0.79 is in the Connect IQ store, tested on a real watch. The other three watch platforms are built and go out with their next store round. Watches with very little memory do not get the graphics \u2014 they do not get custom screens at all, and we would rather leave them out than have them run out of memory mid-session.",
