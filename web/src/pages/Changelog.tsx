...
const ENTRIES: Entry[] = [
  {
    ...
    items: [
      ...
      "The graphics are ready on all four watch platforms and will arrive with the next update of each app. On Garmin they are in version 1.0.79, which you can already sideload; the Play Store and App Store rounds go out when the stores have finished their reviews. Watches with very little memory do not get them \u2014 they do not get custom layouts at all, and we would rather leave them out than have them run out of memory mid-session.",
      "The spot count in the community line and the count on the [spots](/spots) page were telling you different numbers. The community line counted place names, which is not the same as counting spots: a spot whose sessions have no place name yet was simply missing, and a spot that had been renamed could be counted twice. It counts spots now, like the map does. The remaining difference is deliberate \u2014 the map also shows places where only other sports were recorded.",
    ],
  },
  {
    date: "August 25, 2026",
