...
const ENTRIES: Entry[] = [
  {
    ...
    items: [
      ...
      "Apple Watch moves to the highest accuracy setting CoreLocation offers, for the same reason. Apple Watch already had the best coverage of all our watches, so the gain will be smaller there.",
