...
const ENTRIES: Entry[] = [
  {
    ...
    items: [
      ...
      "Garmin watches: you can now choose how many satellite systems the watch uses, separately for each watch, under Account, Watches. All of them find your position fastest and most reliably, which is what the app has been asking for since the last update — but it costs battery, and on a watch with a long battery life you may prefer the smaller setting. The choice takes effect immediately, no update needed on the watch side beyond version 1.0.77, which is in the website download now.",
    ],
  },
  {
    date: "August 14, 2026",
