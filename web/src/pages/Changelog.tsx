...
const ENTRIES: Entry[] = [
  {
    date: "July 21, 2026",
    items: [
      "Carve view on the session map: switch the map to “Carves” to see your carves highlighted — a tight turn of 90° or more (detected from your GPS track; wide, lazy turns don’t count), coloured by how hard you leaned into it (green → yellow → red, from the watch’s accelerometer). Includes a count of your carves by angle (90–180°, 180–360°, over 360°). Great for scrubbing through a session and spotting your carves. Needs a watch that records high-rate motion data (≥15 Hz); shown as an extra view only, not (yet) in records or stats.",
