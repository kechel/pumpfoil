      ...
      {owned && (session.merged_count ?? 0) > 0 && (
        <div className="mt-8 flex flex-wrap items-center gap-2 text-sm text-slate-400">
          ...
          <button
            ...
            disabled={unmerging}
            className="rounded-lg bg-slate-800 px-2.5 py-1 text-slate-200 hover:bg-slate-700 disabled:opacity-50"
          >
...
function ClassificationPanel({ session, owned, onChange }: {
  ...
  // Hat die automatische Erkennung geurteilt (docs/sport-classification.md, Stufe 1b), erklären wir
  ...
  return (
    <div className="mb-4 rounded-xl border border-amber-600/40 bg-amber-500/10 p-3">
      ...
      {picker}
      {/* Widerspruch geht an den Admin und ist NUR nötig, wenn ein Mensch gemeldet hat. Beim reinen
