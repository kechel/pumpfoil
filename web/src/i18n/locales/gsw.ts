...
const gsw: Record<string, string> = {
  ...
  "land.heroSub": "Pumpfoil verbindet dini Garmin-Uhr mit ere detaillierte Analyse: GPS-Track, Foiling-Distanz, Pump-Frequänz und Gleitphase — automatisch us jedere Session.",
  "land.whatTitle": "Was isch Pumpfoil?",
  "land.whatBody": "Pump-Foiling heisst: ufem Hydrofoil ohni Wind, Wälle oder Motor underwägs — du blibsch nume dur rhythmischs Pumpe obe. Pumpfoil zeichnet die Sessions mit de Garmin-Uhr uf und zeigt, wie lang du foilsch, wie effizient du pumpsch und wo du fahrsch.",
  "land.f1Title": "Ufzeichnig mit de Garmin-Uhr",
