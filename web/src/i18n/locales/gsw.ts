...
const gsw: Record<string, string> = {
  ...
  "guide.g.s1a": "„Pump Foil“ usem Connect IQ Store lade — oder s .prg für dis Modäll",
  "guide.g.s1Download": "da abelade",
  "guide.g.s1b": "und mit",
  "guide.g.s1c": "i de Ordner",
  "guide.g.s1d": "vo de Uhr kopiere.",
  "guide.g.s2Title": "2. Code uf de Uhr mache:",
  "guide.g.s2": "Pump Foil ufmache (nöd starte) → MENU halte (Chnopf Mitti-links) → „Yystellige“ → „Verbinde“. D Uhr zeigt en 6-stelltige Code (Händy i de Nöchi oder WLAN nötig).",
