const en: Record<string, string> = {
  ...
  "account.recordModeFull": "Full — acceleration 25 Hz (best pump analysis)",
  "account.recordModeLite": "Lite — acceleration 10 Hz (less memory)",
  "account.recordModeGps": "GPS only — no acceleration (minimal memory)",
  ...
  "land.connectTitle": "Already on Suunto or Polar?",
  "land.connectBody": "Already recording with Suunto or Polar? Connect your account and import your rides automatically as sessions — no extra app needed.",
