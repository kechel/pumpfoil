const en: Record<string, string> = {
  ...
  "setup.stabDesc": "Pick from the catalogue. Many brands don't publish stab dimensions — then you'll only see the name here, and estimated values are marked.",
  "setup.myStabs": "My stabs",
  "setup.stabCatalogEmpty": "Nothing in the catalogue for this search. The stab catalogue is still growing — tell us which brand is missing.",
  "setup.addValue": "Add",
  "setup.setDefault": "Set as default",
  "setup.emptyList": "Nothing added yet.",
  "setup.noSpecs": "no dimensions published",
  "setup.estimatedHint": "Estimated value — not published by the manufacturer.",
