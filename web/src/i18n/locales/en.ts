const en: Record<string, string> = {
  ...
  "land.kann6Title": "Open and fair",
  "land.kann6Body": "Free, open source (AGPL), no tracking. Your data is yours: export as GPX and FIT, and if you like, your own AI can read it — read-only and only yours.",
