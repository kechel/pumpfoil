const en: Record<string, string> = {
  ...
  "adm.usport.hint": "For users who never answer the request to classify. Two separate actions: the profile default only affects FUTURE sessions, resolving only affects the existing sessions with an open request. Resolving as “pumpfoil” also locks those sessions against new reports.",
