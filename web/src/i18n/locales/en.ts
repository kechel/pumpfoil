const en: Record<string, string> = {
  ...
  "upload.supersededOwn": "This recording never arrived in full, and newer sessions have been transferred since — so it is no longer on the watch. Analyse it with the data we have, or delete it below.",
  "upload.analyseNow": "Analyse it now",
