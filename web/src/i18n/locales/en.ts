const en: Record<string, string> = {
  ...
  "sd.tapHelp": "<b>Pump tagging</b> — mark real pumps to train the detector. Pick a session you have a video of and select the lap above. Click <b>Start (3-2-1)</b> and start your video at the same time — at \"0\" the track plays in real time. Hit the <b>spacebar</b> on <b>every</b> pump (or the red <b>PUMP</b> button). Then <b>Save take</b>. Tag the same lap 3–4×, then <b>Compare</b> shows the offset/jitter between runs and a consensus ground truth.",
