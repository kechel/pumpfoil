const en: Record<string, string> = {
  ...
  "social.onYoutube": "On YouTube",
  "social.consentText": "Playing loads the YouTube player. Google receives your IP address and may set cookies — in return you can like the video and follow the channel right here. Until this click, nothing went to Google.",
  "social.consentPlay": "Play video",
  ...
  "imp.yt2": "Only when you <b>click</b> a video does the YouTube player load. On the home page in privacy-enhanced mode (youtube-nocookie.com). In the <b>community feed</b> it is the full YouTube player so you can like and follow the channel there — which is why a notice appears before the first play and you have to confirm it. In both cases Google/YouTube then receives your IP address and may set cookies.",
