const en: Record<string, string> = {
  ...
  "watchQuality.good": "recommended",
  "watchQuality.limited": "with limits",
  "watchQuality.gpsOnly": "GPS only",
  "watchQuality.few": "few data",
  "watchQuality.gpsGood": "{pct}% good",
  "watchQuality.hrOk": "{pct}% missing",
  "watchQuality.hrPending": "no data yet",
  "watchQuality.note": "The positioning column cannot be compared across worlds: Garmin reports a quality grade, Apple and Wear OS report metres. The Apple Watch only tells us its model from the next version on, until then it is one row.",
