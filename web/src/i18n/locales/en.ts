const en: Record<string, string> = {
  "nav.adminPending": "Open moderation (reported + suspected fake)",
  "hr.viewPeak": "Absolute",
  "hr.viewRise": "Rise",
  ...
  "onb.never": "Don't show again",
  "onb.done.feedback": "We're always glad to hear from you: bugs, ideas, wishes — all welcome, in the community chat or through the mailbox on the right. It's only thanks to all the feedback from the community that I could take pumpfoil.org this far this fast.",
  "onb.watch.g1": "Install “Pumpfoil” from the Connect IQ Store onto the watch.",
  "onb.watch.g2": "Start the app on the watch — it shows a code.",
  "onb.watch.g3": "Enter that code here.",
  "onb.watch.a1": "Install “Pumpfoil” from the App Store on your iPhone — the watch app comes with it.",
  "onb.watch.a2": "Sign in on the iPhone with this account.",
  "onb.watch.a3": "The app then connects your Apple Watch by itself.",
  "onb.watch.w1": "Install “Pumpfoil” from the Play Store on your phone and sign in there with this account.",
  "onb.watch.w2": "In the phone app, tap “Install on watch” — it does not reach the watch on its own.",
  "onb.watch.w3": "The app then connects your watch by itself.",
  "onb.watch.z1": "Install the Zepp app on your phone and pair your Amazfit there.",
  "onb.watch.z2": "Install “Pumpfoil” from the Zepp app store onto the watch.",
  "onb.watch.z3": "Start the app on the watch — it shows a code, enter it here.",
  "onb.watch.codeFallback": "Does your watch show a code anyway? Then enter it here.",
  "onb.welcome": "Welcome to pumpfoil.org",
  "onb.foil.defaultHint": "Tap a foil to make it your default (★) — that's what new recordings use.",
  "onb.foil.missing": "Your foil isn't listed?",
  "onb.foil.missingHow": "Tell us through the mailbox on the right what your foil is called exactly — brand, model and size. We'll add it to the catalogue shortly.",
  "onb.link.linked": "Connected",
  "onb.link.leaves": "Connecting takes you to the manufacturer briefly and back — your answers here stay put.",
  "onb.link.unavailable": "Not available right now.",
  "onb.done.more": "All of these and many more settings are in your profile at any time. There's more per watch under Profile / Watch: watch displays from the community, on-foil alarms and further watches. And under Profile / Linked accounts you can connect more accounts.",
  "onb.intro": "A few questions, all optional. Skip any of them and change them later in your profile.",
  "onb.step": "Step {n} of {total}",
  "onb.back": "Back",
  "onb.skip": "Skip",
  "onb.next": "Next",
  "onb.finish": "Done",
  "onb.level.title": "How long have you been pumping?",
  "onb.level.sub": "This sets how sensitively your runs are detected.",
  "onb.level.beginner": "Just starting out",
  "onb.level.inter": "Getting there",
  "onb.level.pro": "I ride confidently",
  "onb.weight.sub": "Together with the foil you ride, we use this to work out the power of your runs in watts, and it sets the alarm thresholds for your foil. Without it we assume 95 kg.",
  "onb.sport.title": "What do you record most?",
  "onb.foil.title": "Your foil",
  "onb.foil.sub": "Optional. Needed for the foil stats, the alarm thresholds and the power calculation.",
  "onb.foil.chosen": "Selected",
  "onb.foil.search": "Search brand or model…",
  "onb.foil.none": "Nothing found.",
  "onb.watch.title": "Connect your watch",
  "onb.watch.sub": "Pick your watch — what to do next appears below.",
  "onb.watch.linked": "Or link an account",
  "onb.watch.fullGuide": "Full guide with pictures",
  "onb.watch.justConnected": "Watch connected.",
  "onb.watch.already": "Already connected:",
  "onb.watch.noWatch": "No watch? You can record with your phone too — install the phone app for that.",
  "onb.done.title": "That's it.",
  "onb.done.withWatch": "Start the recording on your watch and go ride. Once it uploads, your runs show up here.",
  "onb.done.noWatch": "You can connect a watch at any time — in your profile under Watch.",
  ...
  "upload.supersededShort": "A recording is waiting for you to decide",
  "upload.supersededOwn": "This recording never arrived in full, and newer sessions have been transferred since — so it is no longer on the watch. No more data will come: mark it as finished to keep it with what we have, or delete it below.",
  "upload.markFinished": "Mark as finished",
  ...
  "board.roll": "Roll",
  "board.yaw": "Yaw",
  "board.pitchHint": "Nose up / down",
  "board.rollHint": "Lean, carving",
  "board.yawHint": "Turn within {s} s",
  "board.window": "Time window for yaw:",
  "board.noData": "No attitude data for this recording.",
  "board.stats": "Pitch ±{pitch}° · roll ±{roll}° · yaw {yaw}°/s",
  "board.cadence": "Pitch rhythm {hz} Hz",
  "board.zeroStill": "zero from a still moment",
  "board.zeroMean": "zero = average of the run",
  "board.zeroRuns": "zero from the detected runs",
  "board.zeroMid": "zero from the middle section — no run detected",
  "board.atPlay": "playback",
  "board.atMouse": "mouse",
  "board.atEnd": "end of recording",
  "board.rig": "{foil} · {stab} · mast {mast} cm · {board}",
  "board.height": "Height",
  "board.combined": "All in one chart",
  "board.separate": "Separate charts",
  "board.heaveStat": "heave {cm} cm (levelled over {s} s)",
  ...
  "hideloc.title": "Hide location",
  "hideloc.hint": "Your recordings stay visible — just not where you rode. The map and the spot name then show Point Nemo, in the middle of the Pacific. Nobody pumps there, and everyone can see that at a glance.",
  "hideloc.switch": "Hide the location of my recordings",
  "hideloc.scope": "Still visible: the track you rode, all the numbers, your name and your gear. Hidden: the spot, the position on the map and the local time.",
  "hideloc.single": "Applies right away to all your recordings, older ones included. You can release single recordings again in their detail view — or hide only single ones instead.",
  "sd.ortLabel": "Location of this recording",
  "sd.ortProfil": "Location: as in profile",
  "sd.ortZeigen": "Location: show",
  "sd.ortVerbergen": "Location: hide",
  "sd.ortAktiv": "hidden",
  "sd.ortTitle": "Hidden means the map and the spot name show Point Nemo — for everyone, you included. The track itself stays visible.",
  "shared.title": "Shared recordings",
  "shared.hint": "These recordings have a link that lets anyone look at them — no account needed. This is where you take it back.",
  "shared.revoke": "Take back the link",
  "mcp.cardTitle": "AI access (MCP)",
  "mcp.cardHint": "Connect an AI program to your own recordings and have it analyse them there. You put the address below into your program and confirm once here.",
  "mcp.cardUrlLabel": "Address for your AI program",
  "mcp.cardScope": "A connected program may only read, and only your own recordings — no data from other riders, no pictures, no chats.",
  "mcp.copy": "Copy",
  "mcp.copied": "Copied",
  "mcp.none": "No program has access at the moment.",
  "mcp.connectedTitle": "Has access right now",
  "mcp.since": "since {d}",
  "mcp.last": "last {d}",
  "mcp.revoke": "End access",
  "mcp.revokeNote": "After ending it, a program can still read for up to 15 minutes — that is how long its last key lasts. Then it stops.",
  "mcp.consentTitle": "Access to your recordings",
  "mcp.consentIntro": "A program wants to read your pumpfoil recordings. Have a quick look at what that means — and what it does not.",
  "mcp.consentProgram": "The data goes to",
  "mcp.consentGrantTitle": "The program may",
  "mcp.consentGrant1": "read your own recordings: runs, speed, pumps, heart rate, distance, board attitude, equipment",
  "mcp.consentGrant2": "read your own totals and best figures",
  "mcp.consentDenyTitle": "The program may not",
  "mcp.consentDeny1": "change, delete or upload anything — the access is read-only",
  "mcp.consentDeny2": "see data from other riders, not as a comparison either, not even anonymously",
  "mcp.consentDeny3": "reach your photos, videos, messages or ratings",
  "mcp.consentDeny4": "see sorted-out or deleted recordings",
  "mcp.consentRevoke": "You can end the access at any time under “Linked accounts”.",
  "mcp.consentAllow": "Allow access",
  "mcp.consentDenyBtn": "Deny",
  "mcp.consentCancel": "Cancel",
  "mcp.consentBroken": "This request is incomplete. Start the connection again in your AI program.",
  "sd.mergeShareGone": "One of the merged recordings was shared by link — that link no longer works. Share the merged recording again if you want to.",
  "sd.mergeShareGoneN": "{n} of the merged recordings were shared by links — those links no longer work. Share the merged recording again if you want to.",
  "sd.mergeShareGoneOk": "Got it",
  ...
  "home.baPitch": "Pitch",
  "home.baRoll": "Roll",
  "home.baNotDetected": "not detected",
  "home.baCadence": "Cadence",
  "home.baHeave": "Heave",
  "home.baUpTo30s": "up to 30 s",
  ...
  "period.365d": "1 year",
  "period.all": "All time",
  "cr.foilAll": "All foils",
  "cr.foilMine": "Like my foil",
  ...
  "cr.bandMine": "Compared against foils like your {foil} — that is {grenzen}.",
  ...
  "account.stopModeHold": "Hold the button for 2 seconds (default)",
  "account.stopModePress": "A single press is enough",
  "account.stopModeHint": "Applies to all your watches. Holding is the default, so a stray press while foiling ends nothing. “A single press” is for those who are used to it, or whose watch already uses the long press for something else (on some Garmins it is “man overboard”). Holding keeps working, so you gain a second way rather than losing one. For discarding, the watch then asks once.",
  ...
  "account.waterLockOff": "Off",
  "account.waterLockHint": "While pumping, water on the display triggers actions. The lock disables touch until you press a button. \"Automatic\" means the watch decides for itself — only where you cannot lock yourself out. Garmin does not need it.",
  "account.accelWakeup": "Keep the motion sensor awake (test)",
  "account.accelWakeupDefault": "Default ({v})",
  "account.accelWakeupOn": "On",
  "account.accelWakeupOff": "Off",
  "account.accelWakeupHint": "Some Wear OS watches lose motion data when they doze off during a recording – then pumps are missing. \"On\" brings them back but may use more battery. Still being tested: try it, and switch back if your battery suffers. From watch version 1.2.33.",
  ...
  "board.heaveShakyAll": "Heave over the whole recording is not trustworthy: between the runs the board moves slower than the {s}-second window allows, and then every small error gets blown up. The per-run values below are judged on their own — shaky ones are shown in brackets there.",
  "sd.mountSlipped": "Different mounting than in the other runs — the phone was turned, or it shifted",
  "sd.mountDisputed": "The direction was unclear in this run — taken from the run with the stronger signal",
  "sd.colGlide": "longest glide",
  "sd.colMaxHr": "Max HR",
  "sd.colHrStart": "HR start",
  "sd.colHrAvg": "Avg HR",
  "sd.colHrEnd": "HR end",
  ...
  "seo.landTitle": "Pumpfoil — record and analyse pump foiling",
  "seo.landDesc": "Record pump foiling with a Garmin, Apple Watch, Wear OS or Amazfit watch and get every session analysed: GPS track, foiling distance, pump cadence, glide phases. Free and open source.",
  "land.h1": "Pumpfoil — record and analyse pump foiling with your sports watch",
  "land.deepTitle": "How the measuring works",
  "land.deepBody": "We strapped two watches to the same run and measured. Everything is out in the open: what is measured, how pumps are detected, and where the limits are.",
  ...
  "land.watchFeat4Title": "Learns from the phone on the board",
  "land.watchFeat4Body": "Ride with your phone on the board and your watch at the same time, and you show us every real pump — from that we train a pump and glide detection that then works with the watch alone.",
  "land.kannTitle": "The pump foiling app for every sports watch",
  "land.kannBody": "Record on your wrist or on the board, get it analysed automatically: runs, pumps, cadence, glides, heart rate.",
  "land.kann1Title": "Your watch, your data pages",
  "land.kann1Body": "Design your own screens, field by field, coloured by speed or heart rate — separate pages for the run, for the pause and for between runs. On Garmin, Apple Watch, Wear OS and Amazfit.",
  "land.kann2Title": "By the community, for the community",
  "land.kann2Body": "Riders share their layouts. Browse the gallery, see each layout in the shape of your own watch and take it over with one click.",
  "land.kann3Title": "Built for every Garmin",
  "land.kann3Body": "129 Garmin models, each with the version that fits: the full one with custom layouts, a classic one for the mid range such as the Instinct 3, and a slim one for the smallest such as the Instinct 2. No watch gets an app that overruns its memory.",
  "land.kann4Title": "Raw data, not estimates",
  "land.kann4Body": "25 readings a second on the wrist, 50 on the phone, GPS every second, plus heart rate. Everything is stored unchanged — every improvement to the analysis recalculates your old sessions too.",
  ...
  "land.kann6Body": "Connect your own AI, such as Claude, ChatGPT, Gemini or Mistral, through our MCP server and ask it whatever you want to know — how your heart rate developed over the summer or which foil takes you farthest. It reads your sessions and raw data, read-only and only yours. Under “Linked accounts”.",
  ...
  "land.comm1Body": "Farthest and longest run, top speed, longest glide, most runs, pumps and distance in a session, peak heart rate, early bird, night owl and carves — for today, 10 and 30 days, the year and all time. Worldwide, per spot and per foil, with a push when you take one.",
  "land.comm2Title": "Leaderboards",
  "land.comm2Body": "The top 10 by sessions, runs, pumps and spots, filterable by sport and foil size — including “foils like mine”. Plus the spot comparison: which spot gets ridden the most.",
  "land.comm3Title": "Spot map and spot descriptions",
  "land.comm3Body": "Every spot on the map, with weather, spot records and the sessions there. Whoever rides a spot describes it for the others, with up to ten photos — and suggests the right name, which we check and adopt.",
  "land.comm4Title": "Chat per spot",
  "land.comm4Body": "A chat room for every spot, one for everyone and direct messages — with a push when someone writes.",
  "land.comm5Title": "Community layouts for the watch",
  "land.comm5Body": "Share your data pages and take over those of others with one click.",
  "land.comm6Title": "Photos, videos and likes",
  "land.comm6Body": "Attach photos and clips from YouTube, Instagram or TikTok to your session. Likes for sessions, photos and spot descriptions, and the most-liked sessions come out on top.",
  "land.comm7Title": "Your session as an image",
  "land.comm7Body": "Track and numbers as a ready-made image to share — on a map, satellite view or your own photo, with the numbers you want to show.",
  "land.comm8Title": "Share by link, no sign-in needed",
  "land.comm8Body": "A link shows the full analysis of a session — track, runs, heart rate, pumps, gear — even to people without an account. You can take it back at any time.",
  "land.comm9Title": "Compare",
  "land.comm9Body": "Put any session and any run from the community next to your own and play them back at the same time.",
  "land.comm10Title": "Foiler page and foil database",
  "land.comm10Body": "Your own page with records, spots and latest sessions — you decide what is on it. Plus the foil database with the manufacturers’ dimensions.",
  "land.comm11Title": "Lent your watch? Transfer the session",
  "land.comm11Body": "If a friend without a watch rides with yours, send them the session with one click — once they accept, it is theirs, with all runs and records.",
  "land.comm12Title": "Foil and watch statistics",
  "land.comm12Body": "What gets ridden with which foil? Top speed, farthest run, pump cadence and metres per pump for every foil in the community, with its records. And per watch model: how good GPS, heart rate and pump detection really are — before you buy one.",
  ...
  "watches.subStrava": "activity portal",
  ...
  "linked.xiaomi.hint": "There is no direct Xiaomi link — but there is an official detour: Mi Fitness pushes your workouts into the Suunto app, and we pick them up from there. You need a (free) Suunto account for it.",
  "linked.xiaomi.step1": "In Mi Fitness: iPhone → Profile → Connected Apps → authorise Suunto. Android → Profile → Settings → Third Party Data → Suunto.",
  "linked.xiaomi.step2": "Then tap “Connect” in the Suunto card above and use the same Suunto account.",
  "linked.xiaomi.step3": "Go riding. Your sessions arrive here automatically after that.",
  "linked.xiaomi.note": "Xiaomi offers this connection worldwide except in China. An app on the watch itself is not possible — Xiaomi does not allow third-party apps.",
  "land.connectXiaomi": "via Mi Fitness + Suunto",
  "watches.nXiaomi": "No app on the watch (Xiaomi allows no third-party apps). But Mi Fitness officially pushes your workouts into the Suunto app — link Suunto and they arrive here. Instructions under “Linked accounts”.",
  ...
  "import.short": "Import",
  "import.intro": "Upload a recorded activity to have it analysed — FIT, TCX or GPX, also as a ZIP, and older sessions too.",
  ...
  "alarm.hrTitle": "Above max heart rate",
  "alarm.maxHr": "Max",
  "alarm.hrHint": "0 bpm turns the heart-rate alarm off. Needs a heart-rate reading — wrist sensor or chest strap.",
  "alarm.distTitle": "Distance in a run",
  ...
  "settings.sync.why.noGps": "{n} without a GPS track",
  "settings.sync.why.dupe": "{n} already imported",
  "settings.sync.why.tooShort": "{n} too short",
  "settings.sync.why.filtered": "{n} doesn't look like a session",
  "settings.sync.why.later": "{n} will be retried later",
  ...
  "watchQuality.few": "few data",
  "watchQuality.gpsGood": "{pct}% good",
  "watchQuality.hrOk": "{pct}% missing",
  "watchQuality.hrPending": "no data yet",
  "watchQuality.note": "The positioning column cannot be compared across worlds: Garmin reports a quality grade, Apple and Wear OS report metres. The Apple Watch only tells us its model from the next version on, until then it is one row. Heart rate counts new readings per minute, not missing points — that is the only way to see how often a watch really measures.",
  "hr.pickTitle": "Pick your own moment",
  "hr.pickHint": "Drag the slider to the second you care about. Only runs that lasted at least that long are counted.",
  "hr.pickCount": "{n} of {total} sessions have a value here.",
  "hr.pickNone": "Not enough runs this long yet. Drag the slider further left.",
  "hr.afterSecondsExact": "after {sec} seconds",
  ...
  "settings.sync.nothingNew": "Nothing new",
  "settings.sync.imported": "{n} imported",
  ...
  "settings.sports.saved": "Saved",
  "settings.coros.help2": "On the watch, record an outdoor activity with GPS. In our measurements „Flatwater“ gives the best data (one point per second, speed and heart rate complete). Indoor/no-GPS is skipped.",
  ...
  "imp.fbTitle": "Facebook sign-in (“Continue with Facebook”)",
  "imp.fbIntro": "If you sign in with your Facebook account, we process only the following data:",
  "imp.fb1": "<b>Data accessed:</b> your email address, your first name and your Facebook user ID. We do not fetch your surname or your profile picture.",
  "imp.fb2": "<b>Data usage:</b> solely to create and sign in to your Pumpfoil account and to show your first name in the app.",
  "imp.fb3": "There is <b>no access</b> to any other Facebook data — no friend list, no posts, no photos, no pages.",
  "imp.fb4": "This data is <b>not shared with third parties</b>, not used for advertising and not used to train AI/ML models.",
  "imp.fb5": "This website runs <b>no Facebook script and no pixel</b>. Signing in is a redirect that starts only when you press the button — before that, Facebook has nothing to do with your visit.",
  "imp.fbNote": "If you remove pumpfoil.org in your Facebook settings, we delete the link automatically; your Pumpfoil account stays. You can check the status of such a request at <a href=\"/datenloeschung\" class=\"text-brand-400 hover:underline\">Data deletion</a>, and you can delete your account entirely yourself at any time in your profile.",
  ...
  "cls.fileAsk": "Your watch saved this recording as “{sport}”, so we cannot tell whether it was pumpfoiling. Would you classify it? Until then it won’t appear in any stats. If it was pumpfoiling after all, just pick “Pumpfoil”.",
  ...
  "lay.size.smallest": "smallest supported",
  "lay.size.noLayout": "no layout support",
  ...
  "foiler.lastSessions": "Latest 5 sessions",
  ...
  "foiler.basisGps": "GPS only",
  "foiler.basisAccelTip": "Records among all recordings with a motion sensor",
  "foiler.basisGpsTip": "Records among recordings without a motion sensor — watches in GPS mode and account imports",
  // Spot-Namen aendern lassen (Vorschlag, kein Selbstbedienen) — 12.09.2026
  "spotRename.cta": "Suggest a name",
  "spotRename.title": "Suggest a different spot name",
  "spotRename.hint": "Spot names are taken automatically from the nearest place, so they often miss what people actually call it. Send us your suggestion — we look at it and then change the name by hand. It applies to everyone riding here.",
  "spotRename.current": "Current name",
  "spotRename.proposed": "Your suggestion",
  "spotRename.reason": "Why? (optional)",
  "spotRename.send": "Send suggestion",
  "spotRename.sent": "Thanks! Your suggestion is with us. We look at every one of them.",
