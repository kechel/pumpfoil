...
const deAT: Record<string, string> = {
  "hideloc.hint": "Deine Aufnahmen bleibn sichtbar — nur net, wost gfahrn bist. D'Kartn und da Spot-Name zeigen dann Point Nemo, mittn im Pazifik. Dass dort kaner pumpt, siagt a jeder sofort.",
  "hideloc.scope": "Sichtbar bleibn: d'Streckn, olle Zahlen, dei Name und dei Ausruestung. Versteckt wird: da Spot, d'Position auf da Kartn und d'Ortszeit.",
  "hideloc.single": "Gilt sofort fuer olle deine Aufnahmen, a fuer de aeltern. Einzelne kannst in ihrer Detailansicht wieda freigeben — oda umgekehrt nur einzelne verstecken.",
  "hideloc.switch": "Den Ort von meine Aufnahmen verstecken",
  "hideloc.title": "Ort verstecken",
  "sd.ortAktiv": "versteckt",
  "sd.ortLabel": "Ort von dera Aufnahme",
  "sd.ortProfil": "Ort: wia im Profil",
  "sd.ortTitle": "Versteckt haasst: Kartn und Spot-Name zeigen Point Nemo — fuer olle, a fuer di. D'Streckn selba bleibt sichtbar.",
  "sd.ortVerbergen": "Ort: verstecken",
  "sd.ortZeigen": "Ort: zeigen",
  "shared.hint": "Fuer de Aufnahmen gibts an Link, mit dem sie a jeder anschaun kann — a ohne Anmeldung. Do nimmst'n wieda zrugg.",
  "shared.revoke": "Link zruecknehmen",
  "shared.title": "Geteilte Aufnahmen",
  "mcp.cardHint": "Verbind a KI-Programm mit deine eigenen Aufnahmen und lass sie dort auswerten. D'Adresse unten gibst in dei Programm ein und bestätigst amoi do.",
  "mcp.cardScope": "A verbundenes Programm derf nur lesen, und nur deine eigenen Aufnahmen — kane Daten von andere Fahrer, kane Bilder, kane Chats.",
  "mcp.cardTitle": "KI-Zugang (MCP)",
  "mcp.cardUrlLabel": "Adresse fuer dei KI-Programm",
  "mcp.connectedTitle": "Hot grad Zugriff",
  "mcp.consentAllow": "Zugriff erlauben",
  "mcp.consentBroken": "De Anfrage is unvollstaendig. Start d'Verbindung nomoi in deim KI-Programm.",
  "mcp.consentCancel": "Abbrechen",
  "mcp.consentDeny1": "wos aendern, leschen oder hochladen — der Zugriff is nur lesend",
  "mcp.consentDeny2": "Daten von andere Fahrer sehn, a net ois Vergleichswert, a net anonym",
  "mcp.consentDeny3": "an deine Fotos, Videos, Nachrichten oder Bewertungen",
  "mcp.consentDeny4": "aussortierte oder geleschte Aufnahmen sehn",
  "mcp.consentDenyBtn": "Ablehnen",
  "mcp.consentDenyTitle": "S Programm derf net",
  "mcp.consentGrant1": "deine eigenen Aufnahmen lesen: Läuf, Tempo, Pumps, Puls, Strecken, Lage vom Brett, Ausruestung",
  "mcp.consentGrant2": "deine eigenen Summen und Bestwerte lesen",
  "mcp.consentGrantTitle": "S Programm derf",
  "mcp.consentIntro": "A Programm mecht deine Pumpfoil-Aufnahmen lesen. Lies kurz, was des heisst — und was net.",
  "mcp.consentProgram": "D'Daten gengan an",
  "mcp.consentRevoke": "Du kannst'n Zugriff jederzeit unter „Verknuepfte Konten\" wieder beenden.",
  "mcp.consentTitle": "Zugriff auf deine Aufnahmen",
  "mcp.copied": "Kopiert",
  "mcp.copy": "Kopieren",
  "mcp.last": "zuletzt {d}",
  "mcp.none": "Derzeit hot kaa Programm Zugriff.",
  "mcp.revoke": "Zugriff beenden",
  "mcp.revokeNote": "Nachm Beenden kann a Programm no bis zu 15 Minuten weiterlesen — so lang gilt sei letzter Schluessel. Danoch is Schluss.",
  "mcp.since": "seit {d}",
  "board.atEnd": "Ende von der Aufnahme",
  "board.atMouse": "Maus",
  "board.atPlay": "Wiedergabe",
  "board.combined": "Ois in einem Bild",
  ...
  "board.separate": "Getrennte Bilder",
  "board.zeroMid": "Nullpunkt ausm Mittelteil — kaan Lauf erkannt",
  "board.zeroRuns": "Nullpunkt aus de erkannten Läuf",
  "compare.short": "Vergleichen",
  "home.ba1to5min": "1 bis 5 min",
  "home.ba30to60s": "30 s bis 1 min",
  "home.baCadence": "Takt",
  "home.baHeave": "Hub",
  "home.baNotDetected": "net erkannt",
  ...
  "home.boardAttitude": "Lage vom Brett",
  ...
  "onb.done.feedback": "Über Rückmeldungen freuen wir uns jederzeit sehr: Fehler, Ideen, Wünsche — alles ist willkommen, im Community-Chat oder übers Postkastl rechts. Nur durch das viele Feedback aus der Community hab ich pumpfoil.org so schnell so weit gebracht.",
  "onb.watch.g1": "„Pumpfoil“ aus dem Connect IQ Store auf die Uhr laden.",
  "onb.watch.g2": "App auf der Uhr starten — sie zeigt dir einen Code.",
  "onb.watch.g3": "Code da eintragen.",
  "onb.watch.a1": "„Pumpfoil“ aus dem App Store aufs iPhone laden — auf die Apple Watch kommt sie eh mit.",
  "onb.watch.a2": "Am iPhone mit diesem Konto anmelden.",
  "onb.watch.a3": "Die App verbindet deine Apple Watch dann von selber.",
  "onb.watch.w1": "„Pumpfoil“ aus dem Play Store aufs Handy laden und dort mit diesem Konto anmelden.",
  "onb.watch.w2": "In der Handy-App „Auf der Uhr installieren“ antippen — auf die Uhr kommt sie nicht von selber.",
  "onb.watch.w3": "Die App verbindet deine Uhr dann von selber.",
  "onb.watch.z1": "Zepp-App aufs Handy laden und die Amazfit dort verbinden.",
  "onb.watch.z2": "„Pumpfoil“ im Zepp-App-Store auf die Uhr laden.",
  "onb.watch.z3": "App auf der Uhr starten — sie zeigt einen Code, den da eintragen.",
  "onb.watch.codeFallback": "Zeigt deine Uhr trotzdem einen Code? Dann da eintragen.",
  ...
  "onb.foil.missing": "Ist dein Foil nicht dabei?",
  "onb.foil.missingHow": "Sag uns übers Postkastl rechts, wie dein Foil genau heißt — Marke, Modell und Größe. Dann tragen wir es zeitnah in den Katalog ein.",
  "onb.link.linked": "Verbunden",
  "onb.link.leaves": "Zum Verbinden geht's kurz zum Hersteller und dann wieder zurück — deine Antworten da bleiben stehen.",
  "onb.link.unavailable": "Grad nicht verfügbar.",
  "onb.done.more": "Alle diese und viele weitere Einstellungen findest du jederzeit unter Profil. Je Uhr geht noch mehr unter Profil / Uhr: Uhren-Displays aus der Community, On-Foil Alarme und weitere Uhren. Und unter Profil / Verknüpfte Konten kannst du weitere Konten verbinden.",
  "onb.intro": "Ein paar Fragen, alle freiwillig. Du kannst jede überspringen und später im Profil ändern.",
  "onb.step": "Schritt {n} von {total}",
  "onb.back": "Zurück",
  "onb.skip": "Überspringen",
  "onb.next": "Weiter",
  "onb.finish": "Fertig",
  "onb.level.title": "Wie lang pumpst du schon?",
  "onb.level.sub": "Danach richtet sich, wie empfindlich deine Läufe erkannt werden.",
  "onb.level.beginner": "Ich fang grad an",
  "onb.level.inter": "Es geht sich halbwegs aus",
  "onb.level.pro": "Ich fahr sicher",
  "onb.weight.sub": "Daraus rechnen wir zusammen mit dem gefahrenen Foil die Leistung deiner Läufe in Watt, und es legt die Alarmgrenzen für dein Foil fest. Ohne Angabe rechnen wir mit 95 kg.",
  "onb.sport.title": "Was zeichnest du meistens auf?",
  "onb.foil.title": "Dein Foil",
  "onb.foil.sub": "Freiwillig. Nötig für die Foil-Statistiken, die Alarmgrenzen und die Leistungs-Berechnung.",
  "onb.foil.chosen": "Ausgewählt",
  "onb.foil.search": "Marke oder Modell suchen…",
  "onb.foil.none": "Nichts gefunden.",
  "onb.watch.title": "Uhr verbinden",
  "onb.watch.sub": "Wähl deine Uhr — drunter steht, wie's weitergeht.",
  "onb.watch.linked": "Oder ein Konto verknüpfen",
  "onb.watch.fullGuide": "Ausführliche Anleitung mit Bildern",
  "onb.watch.justConnected": "Uhr verbunden.",
  "onb.watch.already": "Schon verbunden:",
  "onb.watch.noWatch": "Keine Uhr? Mit dem Handy aufzeichnen geht auch — dafür die App fürs Handy installieren.",
  "onb.done.title": "Das war's.",
  "onb.done.withWatch": "Starte die Aufnahme auf der Uhr und fahr los. Nach dem Hochladen schaust du deine Läufe gleich da an.",
  "onb.done.noWatch": "Du kannst jederzeit eine Uhr verbinden — im Profil unter Uhr.",
  ...
  "cr.foilAll": "Olle Foils",
  "cr.foilMine": "Wia mei Foil",
  ...
  "sessions.otherWhy": "Diese Aufnahmen wurden nicht als Pumpfoilen gezählt — meist, weil keine Läufe erkannt wurden oder weil ein Lauf fremde Kraft hatte (Schleppen, Motor, Schiffswelle). Sie sind nur für dich sichtbar.",
  "sessions.otherAssign": "War es eine andere Sportart? Session öffnen und die Sportart wählen — dann erscheint sie in deren Kategorie und zählt dort.",
  "sessions.otherDefault": "Machst du eine der anderen Sportarten häufiger?",
  "sessions.otherDefaultLink": "Im Profil als Standard einstellen",
  ...
  "account.deviceForget": "Entfernen",
  "account.deviceHide": "Ausblenden",
  "account.deviceUnhide": "Einblenden",
  "account.deviceHideHint": "Ausgeblendete Uhren bleiben in deinen Aufzeichnungen — sie verschwinden nur aus dieser Liste.",
  "account.devicesShowHidden": "{n} ausgeblendete anzeigen",
  "account.devicesHideHidden": "Ausgeblendete verbergen",
  "account.deviceForgetConfirm": "„{name}“ aus der Liste entfernen? Damit wurde nie eine Session aufgenommen — ein fehlgeschlagener Verbindungsversuch.",
  "account.claimInstallFirst": "Die Uhren-App muss zuerst auf der Uhr installiert sein — der App-Store am Handy liefert die Handy-App, nicht die Uhren-App.",
  ...
  "board.heaveShaky": "Der Hub is für den Lauf nicht belastbar: die Bewegung is langsamer als das {s}-Sekunden-Fenster zulässt, und dann wird beim Umrechnen jeder kleine Fehler riesig. Beim Pumpen mit rund einer Bewegung pro Sekunde stimmt er.",
  "board.heaveShakyAll": "Über die ganze Aufnahme is der Hub nicht belastbar: zwischen die Läufe bewegt si das Brett langsamer als das {s}-Sekunden-Fenster zulässt, und dann wird jeder kleine Fehler riesig. Die Werte je Lauf unten gelten für si — unsichere stengan dort in Klammern.",
  "sd.mountSlipped": "Andere Montage als bei die andern Läufe — das Handy is verdreht worden oder verrutscht",
  ...
  "sd.colHrAvg": "Ø Puls",
  "sd.colHrEnd": "Puls Ende",
  "hr.progressTitle": "Trainingskurve: Puls beim Pumpen",
  "hr.progressHint": "Wie hoch dein Puls nach 30 Sekunden, 1, 2 und 5 Minuten Pumpen steigt.",
  ...
  "land.watchBody": "Eigene Apps für Garmin, Apple Watch, Wear OS und Amazfit mit konfigurierbare Datenfelder — Gschwindigkeit, Puls, Distanz, Zeit. D Aufnahm lauft lokal (aa offline) und wird automatisch synchronisiert.",
  ...
  "land.watchFeat4Body": "Wer mit Handy am Brett und Uhr gleichzeitig foahrt, zeigt uns jeden echten Pump — draus trainiern ma a Pump- und Gleit-Erkennung, de danach mit da Uhr allan funktioniert.",
  "land.kannTitle": "De Pumpfoil-App für jede Sportuhr",
  "land.kannBody": "Aufzeichnen am Handgelenk oder am Brett, auswertn automatisch: Läuf, Pumps, Takt, Gleitstreckn, Puls.",
  "land.kann1Title": "Dei Uhr, deine Datenseitn",
  "land.kann1Body": "Gstalt deine Anzeign söba, Föd für Föd, mit Farbn nach Tempo oder Puls — eigene Seitn für an Lauf, für d Pause und für zwischn de Läuf. Auf Garmin, Apple Watch, Wear OS und Amazfit.",
  "land.kann2Title": "Vo da Community, für de Community",
  "land.kann2Body": "Foahrer teiln eanane Layouts. Stöber in da Galerie, schau da jedes Layout in da Form vo deina eigenen Uhr an und übernimm's mit an Klick.",
  "land.kann3Title": "Für jede Garmin baut",
  "land.kann3Body": "129 Garmin-Modelle, jedes mit da passendn Fassung: de vulle mit eigenen Layouts, a klassische für d Mittelklass wia de Instinct 3 und a schlanke für de klanstn wia de Instinct 2. Ka Uhr kriagt a App, de eanan Speicher sprengt.",
  "land.kann4Title": "Rohdatn statt Schätzung",
  "land.kann4Body": "25 Messungen pro Sekund am Handgelenk, 50 am Handy, GPS jede Sekund, dazua da Puls. Ois bleibt unverändert gspeichert — jede Verbesserung vo da Auswertung rechnet aa deine oidn Sessions nei.",
  "land.kann5Title": "S Handy am Brett misst, wos de Uhr ned siacht",
  "land.kann5Body": "Mit'm Kreisel vom Handy zeigt Pumpfoil, wia dei Brett nickt und rollt, je Lauf und ois bewegte Zeichnung vo deim Foil.",
  "land.kann6Title": "Mit deiner KI auswerten",
  "land.kann6Body": "Verbind deine eigene KI, zum Beispiel Claude, ChatGPT, Gemini oder Mistral, über unsern MCP-Server und frog sie, wos du wissn wüllst — wia sich dei Puls über’n Summa entwickelt hot oder mit wöchem Foil du am weitesten kummst. Sie liest deine Sessions und Rohdaten, nur lesend und nur deine. Unter „Verknüpfte Konten“.",
  "land.commTitle": "Community",
  "land.commBody": "Pumpfoilen macht zaum mehr Spaß. Ois, wos'd foahrst, zöht aa für de aundern — und du siachst, wos an deim Spot los is.",
  "land.comm1Title": "Rekorde",
  "land.comm1Body": "Weitester und längster Lauf, Top-Speed, längste Gleitphase, meiste Läuf, Pumps und Streckn vo ana Session, Höchstpuls, Early Bird, Nachteule und Carves — für heit, 10 und 30 Tog, des Joahr und für imma. Weltweit, je Spot und je Foil, mit Push, wennst an hoist.",
  "land.comm2Title": "Bestenlistn",
  "land.comm2Body": "De Top 10 nach Sessions, Läuf, Pumps und Spots, filterbar nach Sportart und Foil-Größ — aa „Foils wia meins“. Dazua da Spot-Vergleich: wöcher Spot am meistn gfoahrn wird.",
  "land.comm3Title": "Spotkartn und Spotbeschreibungen",
  "land.comm3Body": "Olle Spots auf da Kartn, mit Wetter, Spot-Rekordn und de Sessions dort. Wer an an Spot foahrt, beschreibt'n für de aundern, mit bis zu zehn Fotos — und schlogt an richtigen Nam vor, mia prüfn und übernehman'n.",
  "land.comm4Title": "Chat je Spot",
  "land.comm4Body": "A Chatraum für jedn Spot, ana für olle und Direktnochrichtn — mit Push, wenn wer schreibt.",
  "land.comm5Title": "Community-Layouts für de Uhr",
  "land.comm5Body": "Teil deine Datenseitn und übernimm de vo de aundern mit an Klick.",
  "land.comm6Title": "Fotos, Videos und Likes",
  "land.comm6Body": "Häng Fotos und Clips vo YouTube, Instagram oder TikTok an dei Session. Likes für Sessions, Fotos und Spotbeschreibungen, und de meistgliktn Sessions stehn gaunz obn.",
  "land.comm7Title": "Dei Session ois Büd",
  "land.comm7Body": "Track und Werte ois fertigs Büd zum Teiln — auf da Kartn, am Satellitnbüd oder deim eigenen Foto, mit de Zoin, de'd herzeign wüst.",
  "land.comm8Title": "Teiln per Link, ohne Aumeldung",
  "land.comm8Body": "A Link zeigt de gaunze Auswertung vo ana Session — Track, Läuf, Puls, Pumps, Ausrüstung —, aa für Leit ohne Konto. Du kaunst'n jederzeit zruecknehmen.",
  "land.comm9Title": "Vergleichen",
  "land.comm9Body": "Leg jede Session und jedn Lauf aus da Community neben deine eigenen und spü's gleichzeitig ab.",
  "land.comm10Title": "Foiler-Seitn und Foil-Datenbank",
  "land.comm10Body": "Dei eigene Seitn mit Rekordn, Spots und letztn Sessions — wos drauf steht, entscheidst du. Dazua de Foil-Datenbank mit de Maße vo de Herstöller.",
  "land.comm11Title": "Uhr herborgt? Session übertragen",
  "land.comm11Body": "Foahrt a Freind ohne eigene Uhr mit deina, schickst eam de Session mit an Klick — nimmt er's au, ghört's eam, mit olle Läuf und Rekorde.",
  "land.comm12Title": "Foil- und Uhren-Statistik",
  "land.comm12Body": "Wos wird mit wöchem Foil gfoahrn? Top-Speed, weitester Lauf, Pumptakt und Meter je Pump für jedes Foil vo da Community, mit seine Rekorde. Und je Uhrenmodell: wia guat GPS, Puls und Pump-Erkennung wirklich san — bevorst da ane kaufst.",
  "land.connectTitle": "Automatischer Import via Kontoverknüpfung",
  "land.connectBody": "Verbind dei Konto und importier deine Läuf automatisch als Sessions — ganz ohne zusätzliche App.",
  ...
  "land.f1Body": "Apps für Garmin, Apple Watch, Wear OS und Amazfit nehmen GPS, Puls und rohe Beschleunigung auf — mit konfigurierbare Datenseitn. D Aufnahm lauft aa offline und synchronisiert später vo sölber.",
  ...
  "linked.xiaomi.hint": "Für Xiaomi gibt's kane eigene Verknüpfung — aber an offiziellen Umweg: Mi Fitness schickt deine Trainings in die Suunto-App, und von dort holn ma sie ab. Du brauchst dafür a (kostenloses) Suunto-Konto.",
  "linked.xiaomi.step1": "In Mi Fitness: iPhone → Profil → Verbundene Apps → Suunto autorisieren. Android → Profil → Einstellungen → Daten von Drittanbietern → Suunto.",
  "linked.xiaomi.step2": "Da oben in da Suunto-Kartn auf „Verbinden“ tippn und's gleiche Suunto-Konto verwendn.",
  "linked.xiaomi.step3": "Fahren. Deine Sessions landen danach automatisch bei uns.",
  "linked.xiaomi.note": "Xiaomi bietet die Verbindung weltweit an, außer in China. Auf da Uhr selber kann kane App laufn — Xiaomi lasst fremde Apps net zua.",
  "land.connectXiaomi": "über Mi Fitness + Suunto",
  "watches.nXiaomi": "Kane App auf da Uhr möglich (Xiaomi lasst kane fremden Apps zua). Dafür schickt Mi Fitness deine Trainings offiziell in die Suunto-App — verknüpf Suunto und sie landen bei uns. Anleitung unter „Konten verknüpfen“.",
  ...
  "import.short": "Import",
  "import.intro": "Lod a aufgezeichnete Aktivität aufe zum auswerten — FIT, TCX oder GPX, a ois ZIP und a ältere Sessions.",
  ...
  "alarm.hrTitle": "Über Maximalpuls",
  "alarm.maxHr": "Max",
  "alarm.hrHint": "0 bpm schaltet den Puls-Alarm aus. Es braucht einen Pulswert — Handgelenk oder Brustgurt.",
  "alarm.distTitle": "Strecke im Lauf",
  ...
  "settings.sync.why.noGps": "{n} ohne GPS-Spur",
  "settings.sync.why.dupe": "{n} schon importiert",
  "settings.sync.why.tooShort": "{n} zu kurz",
  "settings.sync.why.filtered": "{n} passt nicht zu einer Session",
  "settings.sync.why.later": "{n} wird später noch einmal probiert",
  ...
  "watchQuality.few": "wenig Daten",
  "watchQuality.gpsGood": "{pct} % gut",
  "watchQuality.hrOk": "{pct} % fehlen",
  "watchQuality.hrPending": "noch keine Daten",
  "watchQuality.note": "Die Ortungsspalte ist nicht zwischen den Welten vergleichbar: Garmin meldet eine Güte-Stufe, Apple und Wear OS melden Meter. Die Apple Watch verrät uns ihr Modell erst ab der nächsten Version, bis dahin steht sie als eine Zeile. Puls zählt neue Messwerte je Minute, nicht fehlende Punkte — nur so ist erkennbar, wie oft eine Uhr wirklich misst.",
  "hr.pickTitle": "Eigener Zeitpunkt",
  "hr.pickHint": "Zieh den Regler auf die Sekunde, die dich interessiert. Es zählen nur Läufe, die mindestens so lang waren.",
  "hr.pickCount": "{n} von {total} Sessions haben hier einen Wert.",
  "hr.pickNone": "Hier gibt es noch zu wenige Läufe. Zieh den Regler weiter nach links.",
  "hr.afterSecondsExact": "nach {sec} Sekunden",
  ...
  "settings.sync.nothingNew": "Nix Neichs",
  ...
  "settings.sports.saved": "Gspeichert",
  "settings.coros.help2": "Auf da Uhr a Outdoor-Aktivität mit GPS aufnehmen. Nach unsane Messungen liefat „Flatwater“ de bestn Datn (a Punkt pro Sekundn, Gschwindigkeit und Puls komplett). Indoor/ohne GPS wird übersprungen.",
  ...
  "social.submitChange": "Änderung einreichen",
  "social.remove": "Entfernen",
  "social.badUrl": "Bitte eine YouTube-Kanal-Adresse angeben",
  "social.stateApproved": "freigegeben",
  "social.statePending": "wartet auf Freigabe",
  "social.stateRejected": "abgelehnt",
  "social.stateBlocked": "Dieser Kanal wurde gesperrt.",
  "adm.tab.social": "Social-Feed",
  "adm.social.pending": "Wartet auf Freigabe",
  "adm.social.approved": "Freigegebene Kanäle",
  "adm.social.reported": "Gemeldete Videos",
  "adm.social.approve": "Freigeben",
  "adm.social.reject": "Ablehnen",
  "adm.social.rejectReason": "Grund für die Ablehnung (sieht der Nutzer):",
  "adm.social.rejectDefault": "passt thematisch nicht",
  ...
  "adm.social.blockChannel": "Kanal sperren",
  "adm.social.unblockChannel": "Kanal entsperren",
  "adm.social.blockVideo": "Video sperren",
  "adm.social.unblockVideo": "Video entsperren",
  ...
  "account.claimReq": "Wichtig: Die Begleit-App deiner Uhr muss am Handy offen und mit der Uhr verbunden sein (Garmin Connect, Zepp, Wear OS bzw. Apple Watch), und das Handy braucht Internet — die Uhr geht übers Handy online. Code innerhalb 15 Min eingeben; erzeugt die Uhr keinen Code, App aktualisieren.",
  "account.claimTitle": "Code von der Uhr eingeben",
  "account.deviceUpdate": "Update verfügbar: v{version} → herunterladen",
  "account.genHelp": "Nur für Garmin: Wenn du den Code nicht an der Uhr ablesen willst, erzeuge ihn hier und trage ihn in der Garmin-Connect-App unter „Pumpfoil“ → Einstellungen ein. Wear OS, Apple Watch und Amazfit haben diesen Weg nicht — dort zeigt die Uhr den Code, den du oben eingibst.",
  "account.genTitle": "Code für Garmin erzeugen",
  ...
  "account.gnssModeL1": "Ohne zweites Frequenzband",
  ...
  "account.waterLockOff": "Aus",
  "account.waterLockHint": "Beim Pumpen löst Wasser am Display Aktionen aus. Die Sperre nimmt die Berührung weg, bis du eine Taste drückst. „Automatisch“ heißt: die Uhr entscheidet selbst — nur dort, wo man sich damit nicht aussperren kann. Garmin braucht sie nicht.",
  "account.accelWakeup": "Bewegungssensor wach halten (Test)",
  "account.accelWakeupDefault": "Standard ({v})",
  "account.accelWakeupOn": "Ein",
  "account.accelWakeupOff": "Aus",
  "account.accelWakeupHint": "Manche Wear-OS-Uhren verlieren Bewegungsdaten, wenn sie während der Aufnahme einschlafen – dann fehlen Pumps. „Ein“ holt sie zurück, kann aber mehr Akku kosten. Noch im Test: probier es aus und stell zurück, falls der Akku leidet. Ab Uhr-Version 1.2.33.",
  ...
  "account.claimNextRecord": "Unten in der Uhren-Liste kannst du für diese Uhr den Aufzeichnungsmodus wählen (25 Hz, 10 Hz oder nur GPS). 10 Hz spart Akku und kostet den Pump-Zähler weniger als ein halbes Prozent. Nur GPS solltest du nicht wählen — damit fallen Pump-Zähler, Kadenz und Gleitphasen ganz weg.",
  "account.claimNextZepp": "Sprache, Pausenansicht und eigene Layouts holt sich deine Amazfit ab jetzt von hier. Den Aufzeichnungsmodus aus der Uhren-Liste übernimmt sie dagegen noch nicht — sie nimmt mit ihrer eigenen Rate auf.",
  ...
  "guide.settings.title": "Einstellungen für deine Uhr",
  "guide.settings.intro": "Sobald die Uhr verbunden ist, findest du unter ",
  "guide.settings.intro2": " zu jeder Uhr zwei Regler. Sie wirken auf die Uhr selbst — sie übernimmt sie beim nächsten Start der App, ohne Update. Wenn dir die Akkulaufzeit wichtig ist, sind das die Stellschrauben.",
  "guide.settings.recordTitle": "Aufzeichnungsmodus (alle Uhren):",
  "guide.settings.record": "25 Hz, 10 Hz oder nur GPS. 10 Hz spart Akku und kostet fast nichts — wir haben beide Raten über dieselben Sessions gerechnet: der Pump-Zähler weicht um weniger als ein halbes Prozent ab, und welche Abschnitte als Foilen zählen, ist zu 99,9 % identisch.",
  "guide.settings.gnssTitle": "Satellitensysteme (nur Garmin):",
  "guide.settings.gnss": "Voreingestellt ist die beste Stufe, die deine Uhr kann — alle Systeme über zwei Frequenzbänder. Die findet die Position am schnellsten und hält sie am besten, kostet aber deutlich Akku. „Ohne zweites Frequenzband“ behält alle Systeme und lässt nur das teure Extraband weg: der größte Spareffekt bei kleinstem Verlust.",
  "guide.settings.gpsWarn": "Nur GPS spart am meisten, wirft aber Pump-Zähler, Kadenz und Gleitphasen komplett weg — also genau die Zahlen, für die diese App da ist. Wähle es nur, wenn deine Uhr sonst nicht durchhält.",
  "guide.settings.zepp": "Bei Amazfit wirkt der Aufzeichnungsmodus noch nicht — die Uhr nimmt mit ihrer eigenen Rate auf. Sprache, Pausenansicht und eigene Layouts holt sie sich dagegen von hier.",
  ...
  "guide.w.s1": "den Play Store auf der Uhr öffnen und nach „Pumpfoil“ suchen.",
  "guide.w.s1Note": "Der Play Store am Handy installiert die Handy-App — die Uhren-App ist eine eigene Installation, direkt auf der Uhr.",
  "guide.w.s1Title": "1. App auf der Uhr installieren:",
  ...
  "imp.fbTitle": "Facebook-Anmeldung („Weiter mit Facebook“)",
  "imp.fbIntro": "Wenn du dich mit deinem Facebook-Konto anmeldest, verarbeiten wir ausschließlich die folgenden Daten:",
  "imp.fb1": "<b>Zugriff:</b> deine E-Mail-Adresse, deinen Vornamen und deine Facebook-Nutzer-ID. Nachnamen und Profilbild holen wir uns nicht.",
  "imp.fb2": "<b>Verwendung:</b> ausschließlich zum Anlegen und Anmelden von deinem Pumpfoil-Konto und um deinen Vornamen in der App herzuzeigen.",
  "imp.fb3": "Es gibt <b>keinen Zugriff</b> auf weitere Facebook-Daten — keine Freundesliste, keine Beiträge, keine Fotos, keine Seiten.",
  "imp.fb4": "Diese Daten werden <b>nicht an Dritte weitergegeben</b>, nicht für Werbung verwendet und nicht zum Trainieren von KI-/ML-Modellen genutzt.",
  "imp.fb5": "Auf dieser Website rennt <b>kein Facebook-Skript und kein Pixel</b>. Die Anmeldung ist eine Weiterleitung, die erst losgeht, wenn du den Knopf drückst — vorher hat Facebook mit deinem Besuch nichts zu tun.",
  "imp.fbNote": "Entfernst du pumpfoil.org in deinen Facebook-Einstellungen, löschen wir die Verknüpfung automatisch; dein Pumpfoil-Konto bleibt. Den Stand von so einer Anfrage findest du unter <a href=\"/datenloeschung\" class=\"text-brand-400 hover:underline\">Datenlöschung</a>, und dein Konto ganz löschen kannst du jederzeit selber im Profil.",
  "del.title": "Datenlöschung",
  "del.done": "Deine Anfrage ist angekommen. Die Verknüpfung zwischen deinem Facebook-Konto und pumpfoil.org ist weg — wir haben keinen Zugriff mehr auf deine Facebook-Daten, und anmelden über Facebook geht damit nicht mehr.",
  "del.code": "Vorgangsnummer:",
  "del.restTitle": "Dein pumpfoil.org-Konto bleibt bestehen",
  "del.rest": "Deine Aufnahmen, Spots und Beiträge bleiben. Das ist Absicht: an einem Konto hängen auch Rekorde und Unterhaltungen mit anderen, und so was löschen wir nicht ungefragt von außen.",
  "del.how": "Willst du auch das Konto und alles drin löschen, geht das jederzeit selber: im Profil unter „Daten & Konto“. Die Löschung ist vollständig und endgültig.",
  ...
  "imp.aiTitle": "KI-Unterstützung (Anthropic Claude)",
  "imp.aiIntro": "Für Auswertung und Weiterentwicklung setzen wir den KI-Assistenten Claude von Anthropic ein. Dabei können Session- und Rohdaten, Feedback sowie Chat-Nachrichten — auch Direktnachrichten — an Anthropic übertragen und dort verarbeitet werden, zu diesen Zwecken:",
  "imp.ai1": "Analyse einzelner Sessions (Fehlersuche, Plausibilitätsprüfung)",
  "imp.ai2": "Verbesserung unserer Erkennungsmodelle (Pump- und On-Foil-Erkennung)",
  "imp.ai3": "Weiterentwicklung der App",
  "imp.ai4": "Recherche fehlender Foils und Stabilizer für den Katalog",
  "imp.aiNote": "Anthropic verarbeitet die Inhalte in unserem Auftrag; nach den geltenden API-Bedingungen werden sie nicht zum Training der Sprachmodelle genutzt. Die Verarbeitung kann in den USA erfolgen. Der Assistent kann im Chat unter eigenem Namen antworten (Konto „Claude Code AI“). Näheres in der <a href=\"https://www.anthropic.com/legal/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-brand-400 hover:underline\">Datenschutzerklärung von Anthropic</a>.",
  ...
  "pumpunit.label": "Pump-Kadenz",
  "pumpunit.hint": "Wia de Pump-Kadenz ozeigt wird: in Hz (Pumps pro Sekundn) oder ois Pumps pro Minutn. Ändert nur de Ozeige.",
  "pumpunit.hz": "Hz",
  "pumpunit.ppm": "Pumps pro Minutn",
  "unit.pumpPerMin": "/min",
  ...
  "cls.sport.sup_paddle": "SUP / Paddeln",
  ...
  "account.browseAll": "In der Pause und Off-Foil auch die übrigen Seiten durchblättern",
  "account.browseAllHint": "An (Standard): du kommst in jedem Zustand auf alle Seiten. Aus: je Zustand nur die hier zugeordneten Screens — aufgeräumter, aber unterwegs ist dann nicht mehr olles erreichbar.",
  "account.emptyStateDefault": "Keine Seite zugeordnet — die Uhr zeigt do ihre Standard-Anzeige.",
  "account.keepOnePage": "Mindestens eine Seite muss bleiben.",
  "account.layoutCanary": "Diese Uhr hat einen Absturz mit eigenem Layout gemeldet ({n}×) — sie zeigt vorläufig die klassischen Ansichten. Andere Uhren san nicht betroffen.",
  "account.layoutCanaryReset": "Nomal probieren",
  ...
  "account.layoutState.off_memory_optin": "Diese Uhr hat wenig Speicher — eigene Layouts kommen nicht automatisch, du kannst sie aber auf der Uhr im Menü „Eigene Layouts“ auf „An“ stellen und es probieren.",
  "account.layoutState.off_model": "Für dieses Uhrenmodell liefern wir eigene Layouts derzeit nicht automatisch aus — mit dem Schalter oben kannst du's trotzdem probieren.",
  ...
  "account.onFoilDesc": "Diese Seiten zeigt die Uhr, während du foilst — mit UP/DOWN blätterst du durch.",
  "account.onFoilTitle": "Während des Laufs",
  "account.pageN": "Seite {n}",
  "account.pauseDesc": "Zeigt die Uhr nur, wenn du die Aufnahme selber pausiert hast (STOP halten → Pausieren). Eigene Screens dieser Art haben immer den „Pausiert“-Hinweis dabei — verschiebbar, aber nicht entfernbar, sonst weiß kaner, wie er weitermacht.",
  "account.pauseTitle": "Aufnahme pausiert",
  "account.toLayouts": "Eigene Layouts",
  "account.useFields": "Datenfelder",
  "account.useLayout": "Eigener Screen",
  "cfr.banner": "Feedback erbeten: Garmin Start / Stopp / Pause",
  "cfr.intro": "Wir haben den Stopp-Screen auf der Garmin-Uhr neu gebaut: 3 Sekunden halten macht a Menü auf — Speichern, Pausieren oder Verwerfen. Machst nix, wird nach 5 Sekunden automatisch gespeichert. Wie findest du das? Kurzes Video unten, Feedback gleich drunter.",
  "cfr.placeholder": "Dein Feedback zum neuen Stopp-Screen…",
  "cfr.sending": "Wird gschickt…",
  "cfr.submit": "Feedback schicken",
  "cfr.thanks": "Danke für dein Feedback!",
  "cfr.title": "Feedback erbeten: neuer Stopp-Screen (Garmin)",
  "cls.appealPending": "Danke — wir schauen uns das an und melden uns.",
  "cls.appealPlaceholder": "Was war's wirklich? (hilft beim Prüfen)",
  "cls.appealSend": "Abschicken",
  "cls.choose": "Sportart wählen …",
  "cls.confirmFlag": "Du glaubst, das ist keine Pumpfoil-Session? Dann kriegt der Besitzer a freundliche Bitte, sie richtig zuzuordnen — zum Beispiel als Wingfoil oder Foildrive. Du bleibst dabei anonym, und es wird kaner beschuldigt: es geht nur drum, dass die Rekorde vergleichbar bleiben.",
  "cls.dq.duplicate": "Doppelte Aufnahme",
  "cls.dq.false_data": "Fehlerhafte Daten",
  "cls.dq.ok": "Daten passen",
  "cls.dq.test": "Test",
  ...
  "cls.wasPumpfoil": "Das war eh Pumpfoilen →",
  "common.close": "Zumachen",
  "compare.barMerge": "Vergleichen & Mergen ({n})",
  "compare.tip": "Tipp: a Session lang gedrückt halten, um mehrere zu markieren und zu vergleichen.",
  "compare.syncTitle": "Synchron abspielen",
  "compare.syncWho": "{n} Fahrer, gleicher Spot, gleiche Zeit",
  "compare.syncHint": "Alle Sessions laufen auf derselben Uhr — du siehst, wer wann wo war. Zeiten, in denen kaner oben war, werden übersprungen.",
  "compare.syncSkipped": "{min} min übersprungen",
  "dm.botEmpty": "Keine Nachrichten in dem Raum.",
  "dm.botNone": "Der Assistent hat no nix geschrieben.",
  "dm.botNote": "Alle Chats von {name} — nur für Admins, rein lesend. Die Zahl zeigt Nachrichten vom Bot von allen im Raum.",
  "dm.tabBot": "Bot",
  "foils.defaultSport": "Standard-Sportart für neue Sessions",
  "foils.defaultSportHint": "Gilt nur für künftige Aufnahmen — bestehende Sessions bleiben, wie sie san. Auf der Uhr wählbar wird das später.",
  "foils.missingCta": "Nachtragen lassen",
  "foils.missingFoil": "Deine Marke oder Größe fehlt im Katalog?",
  "foils.noSpecs": "Maße vom Hersteller no nicht veröffentlicht",
  ...
  "foils.toSetup": "Detailliertes Setup",
  "home.layouts": "Uhr-Layouts aus der Community",
  "home.layoutsAll": "Alle anschauen",
  "home.layoutsHint": "Fertige Aufnahme-Screens von anderen Foilern — anschauen, ins eigene Profil übernehmen, auf deiner Uhr anzeigen.",
  "hrz.bound": "Grenze {n}",
  "hrz.hint": "Grundlage für die Farben der Puls-Anzeige auf der Uhr — Zahl UND Grafik. Der Vorschlag kommt aus deinem höchsten je gemessenen Puls; pass ihn an, wenn du deine Zonen kennst.",
  "hrz.isSuggestion": "Vorschlag aus deinem gemessenen Höchstpuls ({max} bpm). Änder a Zahl, dann gilt deine Einstellung.",
  "hrz.reset": "Zurück zum Vorschlag",
  "hrz.title": "Puls-Zonen",
  "hrz.z1": "Z1 Erholung",
  "hrz.z2": "Z2 Grundlage",
  "hrz.z3": "Z3 Tempo",
  "hrz.z4": "Z4 Schwelle",
  ...
  "lay.addText": "Text",
  "lay.addValue": "Wert",
  "lay.align": "Ausrichtung",
  "lay.align.c": "zentriert",
  "lay.align.l": "links",
  "lay.align.r": "rechts",
  "lay.allCats": "Alle Kategorien",
  "lay.allShapes": "Alle Formen",
  "lay.arcHint": "Auf runden Uhren a Ring am Rand, auf eckigen a Rahmen — die Uhr passt's selber an. Ziehen verschiebt den Startpunkt am Rand entlang.",
  "lay.arcLen": "Länge",
  "lay.arcStart": "Startpunkt am Rand",
  "lay.asAuthor": "Vorschau in Originalgröße vom Autor",
  "lay.authoredFor": "entworfen für {size}",
  "lay.backToList": "Zurück zur Übersicht",
  "lay.barWidth": "Breite",
  "lay.bgColor": "Hintergrundfarbe",
  "lay.byAuthor": "von {name}",
  "lay.cat.off_foil": "Nach dem Lauf",
  "lay.cat.on_foil": "Während des Laufs",
  "lay.cat.pause": "Pause zwischen den Läufen",
  "lay.catDesc.off_foil": "Die kurze Zusammenfassung gleich nach einem Lauf.",
  "lay.catDesc.on_foil": "Beliebig viele Seiten — auf der Uhr wischbar.",
  "lay.catDesc.pause": "Was die Uhr zeigt, während du zwischen zwei Läufen dümpelst.",
  "lay.color": "Farbe",
  "lay.colorByScale": "Farbe nach Zone/Skala",
  "lay.colorByValue": "Farbe nach Wert (wie auf der Uhr)",
  "lay.copiedGoto": "Kopiert — zu meinen Layouts",
  "lay.copies": "{n}× kopiert",
  "lay.copy": "Kopieren",
  "lay.copyToMine": "Ins eigene Profil kopieren",
  "lay.delConfirm": "Das Layout löschen?",
  "lay.delElement": "Element entfernen",
  "lay.draft": "privat",
  "lay.dragHint": "Element antippen und ziehen, um's zu platzieren. Die Uhrengröße oben ist nur zum Prüfen — beim Speichern merken wir sie als „entworfen für“.",
  "lay.edit": "Bearbeiten",
  "lay.empty": "No kein Layout in der Kategorie.",
  "lay.field": "Datenfeld",
  "lay.size.rect": "rechteckig",
  "lay.size.smallest": "kleinste unterstützte",
  "lay.size.noLayout": "kein Layout-Support",
  "lay.galleryEmpty": "No nix veröffentlicht. Veröffentlich dein Layout — dann sehen's die anderen do.",
  "lay.galleryHint": "Veröffentlichte Layouts von anderen anschauen und ins eigene Profil kopieren. Die Vorschau nimmt standardmäßig die Größe deiner Uhr — kopieren kannst du jedes Layout, auch wenn's für a andere Größe oder Form entworfen wurde (die Positionen san relativ).",
  "lay.galleryTitle": "Layouts aus der Community",
  "lay.graphicFieldHint": "Nur Felder mit Skala: Puls (Zonen aus dem Profil) und Geschwindigkeit.",
  "lay.hasFreetext": "enthält eigene Texte",
  "lay.hint": "Datenfelder, Labels und Trennlinien frei am Uhr-Display platzieren — Größe, Farbe, Hintergrund und Form inklusive. A Layout ist EINE Seite; die Kategorie sagt, wann sie gezeigt wird.",
  "lay.isCopy": "Kopie",
  "lay.lineFree": "Frei/diagonal",
  "lay.lineH": "Waagrecht",
  "lay.lineHint": "Die Linie ziehen verschiebt sie ganz; die zwei Punkte an den Enden ziehen sie frei.",
  "lay.lineLength": "Länge",
  "lay.lineOrient": "Ausrichtung",
  "lay.lineV": "Senkrecht",
  "lay.lineX2": "Ende X",
  "lay.lineY2": "Ende Y",
  "lay.maxElements": "Mehr Elemente gehen sich auf einer Seite nicht aus.",
  "lay.new": "Neues Layout",
  "lay.newText": "Text",
  "lay.notFound": "Layout nicht gefunden.",
  "lay.notOnWatchYet": "Die Uhr zeigt diese Layouts no nicht — sie werden do vorbereitet, die Uhr-Unterstützung kommt in einem der nächsten Updates. Deine bestehenden 3-Feld-Ansichten laufen unverändert weiter.",
  "lay.ownWatchNote": "Vorschau in der Größe deiner Uhr ({name}).",
  "lay.pausedFixed": "Pflicht-Hinweis — verschiebbar, nicht entfernbar",
  "lay.pausedHint": "Pausiert",
  "lay.publish": "Veröffentlichen",
  "lay.published": "veröffentlicht",
  "lay.saveErr": "Hat nicht gespeichert werden können.",
  "lay.scaleHint": "Skala: Puls {hr} bpm, Geschwindigkeit {speed} km/h — im Profil einstellbar.",
  "lay.selectHint": "A Element in der Vorschau oder unten anwählen, um's zu ändern.",
  ...
  "lay.sizeTextCap": "Größer geht nur bei Werten: die großen Uhr-Schriften haben nur Ziffern, keine Buchstaben.",
  ...
  "lay.toCommunity": "Layouts aus der Community",
  "lay.toSimple": "Einfache Ansichten (3 Felder)",
  "lay.type.1": "Wert",
  "lay.type.2": "Label",
  "lay.type.3": "Eigener Text",
  "lay.type.4": "Trennlinie",
  "lay.type.5": "REC-Punkt",
  "lay.type.6": "Seiten-Punkte",
  "lay.type.7": "„Pausiert“-Hinweis",
  ...
  "linked.connectError": "Verbinden ist schiefgegangen — bitte nomal probieren.",
  ...
  "merge.confirm": "Du kannst die {n} Sessions zu einer einzigen zusammenführen. Der Vorgang lässt sich nicht rückgängig machen.",
  "merge.hint": "{n} Sessions von heut könnten zusammengehören.",
  ...
  "sd.excludeConfirm": "Den Lauf aus der Auswertung nehmen?\n\nEr zählt dann nimmer bei Läufen, Foil-Zeit, Distanz, Pumps und Rekorden. Die Aufnahme selber bleibt vollständig gespeichert — du kannst den Lauf jederzeit wieder reinnehmen.",
  "sd.excludeFail": "Hat nicht gespeichert werden können: ",
  ...
  "sd.excludeRangeHint": "Liegt der Störteil mitten in der Aufnahme (z. B. Autofahrt zwischen zwei Spots), kannst du stattdessen den gewählten Bereich aussortieren — der Rest davor und danach bleibt in der Auswertung.",
  "sd.excludeRun": "Lauf aussortieren",
  "sd.excludedHint": "Die Zeitabschnitte zählen nicht in die Auswertung (Läufe, Foil-Zeit, Distanz, Pumps, Rekorde). Die Aufnahme bleibt vollständig gespeichert — jederzeit umkehrbar.",
  "sd.excludedTitle": "{n} Läufe aussortiert",
  "sd.excludedTitleOne": "1 Lauf aussortiert",
  "sd.exportFail": "Download ist schiefgegangen",
  "sd.exportFit": "Als FIT-Datei runterladen (für Garmin Connect, Strava & Co.)",
  ...
  "sessions.deleteAllOtherConfirm": "Wirklich ALLE aussortierten Sessions löschen? Das betrifft nur deine eigenen aussortierten (Nicht-Pumpfoil) Sessions — deine Pumpfoil-Sessions bleiben unberührt. Das lässt sich nicht rückgängig machen.",
  ...
  "sessions.uploadSkipped": "{skipped} von {total} Dateien übersprungen — das san keine Aktivitäten (z. B. Tagesaufzeichnungen der Uhr). Alles andere wurde importiert.",
  "sessions.uploadSkippedOne": "Nicht importiert: {reason}.",
  "settings.suunto.broken": "⚠ Die Verknüpfung mit Suunto geht momentan nicht: die Anmeldung bei Suunto lauft durch (du kriegst von Suunto sogar a Bestätigungs-Mail), aber Suunto verweigert unserer App danach den Zugriff auf dein Konto. Der Fehler liegt nicht bei dir und nicht an deinem Passwort — wir klären das mit Suunto. Bis dahin kannst du Suunto-Aktivitäten als Datei importieren.",
  "setup.addValue": "Hinzufügen",
  "setup.boardDelConfirm": "Das Board löschen? Sessions, die's nutzen, fallen zurück auf deinen Standard.",
  "setup.boardDesc": "Deine Boards trägst du selber ein (Name, optional Volumen und Länge) — dafür gibt's kein Hersteller-Katalog.",
  "setup.boardLenPlaceholder": "cm",
  "setup.boardNamePlaceholder": "Board-Name",
  "setup.boardTitle": "Boards",
  "setup.boardVolPlaceholder": "Liter",
  "setup.emptyList": "No nix eingetragen.",
  "setup.hint": "Stab, Mastlänge, Shim und Boards — genau wie bei den Foils: markieren, was du hast, an Standard setzen (Stern), und je Session umstellen. Rein informativ, es wird nix damit gerechnet.",
  "setup.mastDesc": "Deine Mastlängen in cm. Der Stern markiert den Standard für neue Sessions.",
  "setup.mastPlaceholder": "z. B. 85",
  "setup.mastTitle": "Mastlänge",
  "setup.missingStab": "Dein Stabilizer fehlt im Katalog?",
  "setup.myStabs": "Meine Stabs",
  "setup.noSpecs": "keine Maße veröffentlicht",
  "setup.ownStab": "eigener Eintrag (nur für dich sichtbar)",
  "setup.setDefault": "Als Standard setzen",
  "setup.shimDesc": "Deine Shims in Grad — negativ, 0 oder positiv (z. B. −1, 0, +0,5, +2). Halbe und Zehntelgrade san erlaubt.",
  "setup.shimPlaceholder": "z. B. +1,5",
  "setup.shimTitle": "Shim (Anstellwinkel)",
  "setup.stabAddErr": "Hat nicht angelegt werden können — die Bezeichnung ist schon vergeben.",
  "setup.stabAddHint": "Nicht dabei? Bezeichnung selber anlegen — sie ist vorerst nur für dich sichtbar, gute Einträge übernehmen wir später in die allgemeine Liste.",
  "setup.stabBrandPlaceholder": "Marke",
  "setup.stabCatalogEmpty": "Für die Suche ist nix in der Liste — leg die Bezeichnung einfach selber an.",
  "setup.stabDelConfirm": "Den eigenen Eintrag löschen? Sessions, die ihn nutzen, fallen zurück auf deinen Standard.",
  ...
  "share.copy": "Kopieren",
  "share.cta": "Jetzt selber tracken",
  "share.darken": "Abdunkeln",
  "share.highlightRun": "Lauf hervorheben",
  "share.linkBtn": "Teilen-Link",
  "share.linkExplain": "Jeder mit dem Link sieht die Session (nur anschauen) — ganz ohne Konto. Zum Abdrehen den Link deaktivieren.",
  ...
  "share.revokeConfirm": "Den Teilen-Link deaktivieren? Er funktioniert danach nimmer.",
  ...
  "spotnote.addPhoto": "Foto hinzufügen",
  "spotnote.deleteConfirm": "Eigene Spot-Beschreibung samt Fotos löschen?",
  "spotnote.disclaimer": "Hinweise aus der Community — ohne Gewähr. Verlass dich am Wasser auf deine eigene Einschätzung.",
  "spotnote.edit": "Bearbeiten",
  "spotnote.error": "Hat nicht hingehaut.",
  "spotnote.fromSession": "Aus meinen Session-Fotos",
  "spotnote.invite": "Du warst do schon foilen — beschreib den Spot für die anderen: Startstelle, Untergrund, was man wissen sollt.",
  "spotnote.moveLeft": "nach vorn",
  "spotnote.moveRight": "nach hinten",
  "spotnote.noSessionPhotos": "Du hast an dem Spot no keine Session-Fotos.",
  "spotnote.none": "Für den Spot gibt's no keine Beschreibung.",
  "spotnote.photos": "Fotos",
  "spotnote.placeholder": "Wie startet man do? Steg, Beach, Drop-in? Untergrund, Strömung, Parken, Hinweise …",
  "spotnote.reportConfirm": "Die Beschreibung als unangemessen melden?",
  "spotnote.title": "Spot-Beschreibungen",
  "spotnote.updated": "aktualisiert",
  "spotnote.uploadFail": "Das Foto hat nicht gespeichert werden können.",
  "spotnote.write": "Meine Spot-Beschreibung",
  "spots.onlyWithNotes": "Nur mit Beschreibung",
  "spz.bound": "Grenze {n}",
  "spz.hint": "Dieselbe Skala für die Geschwindigkeit: sie färbt die Zahl auf der Uhr und die Wert-Grafiken in eigenen Layouts. Der Vorschlag kommt aus deiner eigenen gefahrenen Geschwindigkeit.",
  "spz.isSuggestion": "Vorschlag aus deiner gefahrenen Geschwindigkeit (bis {max} km/h). Änder a Zahl, dann gilt deine Einstellung.",
  "spz.reset": "Zurück zum Vorschlag",
  "spz.title": "Geschwindigkeits-Zonen",
  "spz.z1": "Z1 langsam",
  "spz.z2": "Z2 Gleiten",
  "spz.z3": "Z3 Tempo",
  "spz.z4": "Z4 schnell",
  ...
  "upload.finalizeConfirm": "Die Session mit den bisher hochgeladenen Daten abschließen und auswerten? Fehlende Beschleunigungsdaten werden nimmer nachgeladen (reine GPS-Auswertung).",
  ...
  "upload.supersededShort": "Eine Aufnahme wartet auf deine Entscheidung",
  "upload.supersededOwn": "Diese Aufnahme ist nie vollständig angekommen, und seither sind neuere Sessions übertragen worden — sie liegt also nicht mehr auf der Uhr. Es kommen keine Daten mehr: markiere sie als abgeschlossen, dann bleibt sie mit dem, was da ist, oder lösche sie weiter unten.",
  "upload.markFinished": "Als abgeschlossen markieren",
