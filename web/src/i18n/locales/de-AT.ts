...
const deAT: Record<string, string> = {
  ...
  "land.connectTitle": "Schon a Suunto oder Polar?",
  "land.connectBody": "Du zeichnest scho mit Suunto oder Polar auf? Verbind dei Konto und importier deine Läuf automatisch als Sessions — ganz ohne zusätzliche App.",
