...
const deAT: Record<string, string> = {
  ...
  "upload.supersededOwn": "Diese Aufnahme ist nie vollständig angekommen, und seither sind neuere Sessions übertragen worden — sie liegt also nicht mehr auf der Uhr. Werte sie mit den vorhandenen Daten aus oder lösche sie weiter unten.",
  "upload.analyseNow": "Jetzt auswerten",
