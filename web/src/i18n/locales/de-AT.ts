...
const deAT: Record<string, string> = {
  ...
  "land.kann6Title": "Offn und fair",
  "land.kann6Body": "Gratis, quelloffn (AGPL), ohne Tracking. Deine Datn ghörn dir: Export ois GPX und FIT, und wennst wüst, liest dei eigene KI mit — nur lesend und nur deine.",
