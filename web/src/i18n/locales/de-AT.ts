...
const deAT: Record<string, string> = {
  ...
  "settings.polar.gpsHint": "Wichtig: im Polar-Sportprofil muass GPS eingschoitn sei. Bei Wasser-Profilen haaßt der Hakerl „GPS vom Handy verwenden“ — ohne den zeichnet de Uhr kaa Position auf, und ohne Position kann ma a Session net auswerten.",
  ...
  "settings.coros.testHint": "Die Anbindung is ganz neu und no net mit echte Trainings erprobt — mir gfreun uns sehr, wenn's wer ausprobiert. Du musst dafür kane echte Pump-Session fahrn: a Spaziergang von 100 Metern draußn reicht völlig. Sag uns danach kurz Bescheid — im Chat an Jan oder übers Feedback-Formular —, dann schaun ma uns den Import an.",
