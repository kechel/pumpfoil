...
const de: Record<string, string> = {
  ...
  "setup.stabDesc": "Aus dem Katalog auswählen. Bei Stabs veröffentlichen viele Hersteller keine Maße — dann steht hier nur die Bezeichnung, und geschätzte Werte sind markiert.",
  "setup.myStabs": "Meine Stabs",
  "setup.stabCatalogEmpty": "Für diese Suche ist nichts im Katalog. Der Stab-Katalog wächst noch — schreib uns, welche Marke fehlt.",
  ...
  "setup.estimatedHint": "Geschätzter Wert — vom Hersteller nicht veröffentlicht.",
