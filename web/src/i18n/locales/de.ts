...
const de: Record<string, string> = {
  ...
  "land.heroSub": "Pumpfoil verbindet deine Garmin-Uhr mit detaillierter Analyse: GPS-Track, Foiling-Distanz, Pump-Frequenz und Gleitphasen — automatisch aus jeder Session.",
  "land.whatTitle": "Was ist Pumpfoil?",
  "land.whatBody": "Pump-Foiling heißt: auf dem Hydrofoil ohne Wind, Wellen oder Motor unterwegs — du hältst dich allein durch rhythmisches Pumpen oben. Pumpfoil zeichnet diese Sessions mit der Garmin-Uhr auf und macht sichtbar, wie lange du foilst, wie effizient du pumpst und wo du fährst.",
  "land.f1Title": "Aufzeichnung per Garmin-Uhr",
  ...
  "land.openBody": "Pumpfoil ist ein Community-Projekt mit freier Open-Source-Software unter der AGPL-3.0. Der Quellcode landet bald auf GitHub.",
