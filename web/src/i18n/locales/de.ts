...
const de: Record<string, string> = {
  ...
  "account.claimHelp": "Pump Foil auf der Uhr öffnen (nicht starten) → MENU halten (Knopf Mitte-links) → „Einstellungen“ → „Verbinden“. Der angezeigte Code (6 Zeichen, Buchstaben & Ziffern) hier eintragen. Handy in der Nähe oder WLAN nötig, damit die Uhr den Code erzeugen kann.",
  ...
  "guide.g.s1a": "„Pump Foil“ aus dem Connect IQ Store laden — oder die .prg für dein Modell",
  ...
  "guide.g.s2": "Pump Foil öffnen (nicht starten) → MENU halten (Knopf Mitte-links) → „Einstellungen“ → „Verbinden“. Die Uhr zeigt einen 6-stelligen Code (Handy in der Nähe oder WLAN nötig).",
