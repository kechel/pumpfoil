...
const de: Record<string, string> = {
  ...
  "home.baFooter": "Aus {sessions} Aufnahmen mit {runs} Läufen. Gieren braucht einen Kreisel, der Hub einen klar erkannten Pumptakt — fehlt eins davon, steht ein Strich.",
