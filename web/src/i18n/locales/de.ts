...
const de: Record<string, string> = {
  ...
  "onb.next": "Weiter",
  "onb.finish": "Fertig",
  "onb.lang.sub": "Wirkt sofort und gilt auch auf der Uhr.",
  ...
  "onb.level.effect": "Diese Stufe ist die maßgebliche Auswertung deiner Sessions — auch in der Community und in den Rekorden. Du kannst sie jederzeit im Profil ändern.",
  "onb.weight.sub": "Legt die Alarmgrenzen für dein Foil fest. Ohne Angabe rechnen wir mit 95 kg.",
  "onb.sport.title": "Was zeichnest du meistens auf?",
  "onb.sport.sub": "Gilt nur für neue Aufnahmen.",
  "onb.foil.title": "Dein Foil",
  "onb.foil.sub": "Freiwillig. Nötig für die Foil-Statistiken und die Alarmgrenzen.",
  "onb.foil.chosen": "Ausgewählt",
  "onb.foil.search": "Marke oder Modell suchen…",
  "onb.foil.none": "Nichts gefunden.",
  "onb.foil.all": "Alle Foils ansehen",
  ...
  "onb.watch.linkedHow": "Bei diesen Marken zeichnet die Uhr mit ihrer eigenen App auf, und wir holen die Aufnahme aus deinem Konto ab.",
  "onb.watch.s1": "App auf der Uhr installieren.",
  "onb.watch.s2": "App auf der Uhr starten — sie zeigt einen Code.",
  "onb.watch.s3": "Code hier eintragen.",
