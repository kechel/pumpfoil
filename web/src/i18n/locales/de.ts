...
const de: Record<string, string> = {
  ...
  "land.comm3Body": "Alle Spots auf der Karte, mit Wetter, Spot-Rekorden und den Sessions dort. Wer an einem Spot fährt, beschreibt ihn für die anderen, mit bis zu zehn Fotos.",
