...
const de: Record<string, string> = {
  ...
  "sd.tapHelp": "<b>Pump-Tagging</b> — echte Pumps markieren, um die Erkennung zu trainieren. Nimm eine Session, von der du ein Video hast, und wähle oben den Lauf. <b>Start (3-2-1)</b> klicken und gleichzeitig das Video starten — bei „0“ läuft die Strecke in Echtzeit. Bei <b>jedem</b> Pump die <b>Leertaste</b> drücken (oder den roten <b>PUMP</b>-Button). Am Ende <b>Take speichern</b>. Denselben Lauf 3–4× taggen — <b>Vergleichen</b> zeigt dann Versatz/Jitter zwischen den Durchläufen und einen Konsens als Wahrheit.",
