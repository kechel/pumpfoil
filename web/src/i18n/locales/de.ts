...
const de: Record<string, string> = {
  ...
  "hrz.hint": "Grundlage für die Farben der Puls-Grafiken auf der Uhr. Der Vorschlag kommt aus deinem höchsten je gemessenen Puls — passe ihn an, wenn du deine Zonen kennst.",
  "hrz.z1": "Z1 Erholung",
  "hrz.z2": "Z2 Grundlage",
  "hrz.z3": "Z3 Tempo",
  "hrz.z4": "Z4 Schwelle",
