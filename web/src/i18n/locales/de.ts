...
const de: Record<string, string> = {
  ...
  "onb.done.upload": "§Hochgeladen wird nur, solange die Pumpfoil-App auf der Uhr offen und mit Handy oder WLAN verbunden ist.§ Ist die App zu, bleibt die Aufnahme sicher auf der Uhr und geht beim nächsten Öffnen von selbst hoch. Den Fortschritt siehst du in der Uhren-App, und du kannst den Upload dort auch nachträglich starten — bei Garmin über Menü → Upload / Sync.",
  ...
  "onb.watch.a1": "„Pumpfoil“ aus dem App Store aufs iPhone laden — auf die Apple Watch kommt sie mit.",
  "onb.watch.a2": "Auf dem iPhone mit diesem Konto anmelden.",
  "onb.watch.a3": "Die App verbindet deine Apple Watch dann von selbst.",
  "onb.watch.w1": "„Pumpfoil“ aus dem Play Store aufs Handy laden und dort mit diesem Konto anmelden.",
  "onb.watch.w2": "In der Handy-App „Auf der Uhr installieren“ antippen — auf die Uhr kommt sie nicht von allein.",
  "onb.watch.w3": "Die App verbindet deine Uhr dann von selbst.",
  ...
  "onb.link.leaves": "Zum Verbinden geht es kurz zum Hersteller und danach zurück — deine Antworten hier bleiben stehen.",
  "onb.link.unavailable": "Gerade nicht verfügbar.",
  ...
  "onb.next": "Weiter",
  "onb.finish": "Fertig",
  "onb.level.title": "Wie lange pumpst du schon?",
  "onb.level.sub": "Danach richtet sich, wie empfindlich deine Läufe erkannt werden.",
  "onb.level.beginner": "Ich fange an",
  "onb.level.inter": "Es läuft so halb",
  "onb.level.pro": "Ich fahre sicher",
  "onb.weight.sub": "Daraus berechnen wir zusammen mit dem gefahrenen Foil die Leistung deiner Läufe in Watt, und es legt die Alarmgrenzen für dein Foil fest. Ohne Angabe rechnen wir mit 95 kg.",
  ...
  "onb.watch.sub": "Wähle deine Uhr — darunter steht, wie es weitergeht.",
  ...
  "onb.done.withWatch": "Starte die Aufnahme auf der Uhr und fahr los. Nach dem Hochladen siehst du deine Läufe hier.",
  ...
  "board.zeroRuns": "Nullpunkt aus den erkannten Läufen",
  "board.zeroMid": "Nullpunkt aus dem Mittelteil — kein Lauf erkannt",
  "board.atPlay": "Wiedergabe",
  "board.atMouse": "Maus",
  "board.atEnd": "Ende der Aufnahme",
  "board.rig": "{foil} · {stab} · Mast {mast} cm · {board}",
  "board.height": "Höhe",
  "board.combined": "Alles in einem Bild",
  "board.separate": "Getrennte Bilder",
  "board.heaveStat": "Hub {cm} cm (über {s} s ausgerichtet)",
  ...
  "hideloc.title": "Ort verbergen",
  "hideloc.hint": "Deine Aufnahmen bleiben sichtbar — nur nicht, wo du gefahren bist. Karte und Spotname zeigen dann Point Nemo, mitten im Pazifik. Dass dort niemand pumpt, sieht jeder sofort.",
  "hideloc.switch": "Den Ort meiner Aufnahmen verbergen",
  "hideloc.scope": "Sichtbar bleiben: die gefahrene Strecke, alle Zahlen, dein Name und deine Ausrüstung. Verborgen werden der Spot, die Position auf der Karte und die Ortszeit.",
  "hideloc.single": "Gilt sofort für alle deine Aufnahmen, auch für die älteren. Einzelne kannst du in ihrer Detailansicht wieder freigeben — oder umgekehrt nur einzelne verbergen.",
  "sd.ortLabel": "Ort dieser Aufnahme",
  "sd.ortProfil": "Ort: wie im Profil",
  "sd.ortZeigen": "Ort: zeigen",
  "sd.ortVerbergen": "Ort: verbergen",
  "sd.ortAktiv": "verborgen",
  "sd.ortTitle": "Verborgen heißt: Karte und Spotname zeigen Point Nemo — für alle, auch für dich. Die Strecke selbst bleibt sichtbar.",
  "shared.title": "Geteilte Aufnahmen",
  "shared.hint": "Für diese Aufnahmen gibt es einen Link, mit dem jeder sie ansehen kann — auch ohne Anmeldung. Hier nimmst du ihn wieder zurück.",
  "shared.revoke": "Link zurücknehmen",
  "mcp.cardTitle": "KI-Zugang (MCP)",
  "mcp.cardHint": "Verbinde ein KI-Programm mit deinen eigenen Aufnahmen und lass sie dort auswerten. Du trägst die Adresse unten in deinem Programm ein und bestätigst einmal hier.",
  "mcp.cardUrlLabel": "Adresse für dein KI-Programm",
  "mcp.cardScope": "Ein verbundenes Programm darf nur lesen, und nur deine eigenen Aufnahmen — keine Daten anderer Fahrer, keine Bilder, keine Chats.",
  "mcp.copy": "Kopieren",
  "mcp.copied": "Kopiert",
  "mcp.none": "Zurzeit hat kein Programm Zugriff.",
  "mcp.connectedTitle": "Hat gerade Zugriff",
  "mcp.since": "seit {d}",
  "mcp.last": "zuletzt {d}",
  "mcp.revoke": "Zugriff beenden",
  "mcp.revokeNote": "Nach dem Beenden kann ein Programm noch bis zu 15 Minuten weiterlesen — so lange gilt sein letzter Schlüssel. Danach ist Schluss.",
  "mcp.consentTitle": "Zugriff auf deine Aufnahmen",
  "mcp.consentIntro": "Ein Programm möchte deine Pumpfoil-Aufnahmen lesen. Lies kurz, was das heißt — und was es nicht heißt.",
  "mcp.consentProgram": "Die Daten gehen an",
  "mcp.consentGrantTitle": "Das Programm darf",
  "mcp.consentGrant1": "deine eigenen Aufnahmen lesen: Läufe, Geschwindigkeit, Pumps, Puls, Strecke, Lage des Bretts, Ausrüstung",
  "mcp.consentGrant2": "deine eigenen Summen und Bestwerte lesen",
  "mcp.consentDenyTitle": "Das Programm darf nicht",
  "mcp.consentDeny1": "irgendetwas ändern, löschen oder hochladen — der Zugriff ist ausschließlich lesend",
  "mcp.consentDeny2": "Daten anderer Fahrer sehen, auch nicht als Vergleichswert, auch nicht anonym",
  "mcp.consentDeny3": "an deine Fotos, Videos, Nachrichten oder Bewertungen",
  "mcp.consentDeny4": "aussortierte oder gelöschte Aufnahmen sehen",
  "mcp.consentRevoke": "Du kannst den Zugriff jederzeit unter „Verknüpfte Konten\" wieder beenden.",
  "mcp.consentAllow": "Zugriff erlauben",
  "mcp.consentDenyBtn": "Ablehnen",
  "mcp.consentCancel": "Abbrechen",
  "mcp.consentBroken": "Diese Anfrage ist unvollständig. Starte die Verbindung noch einmal in deinem KI-Programm.",
  "sd.mergeShareGone": "Eine der zusammengeführten Aufnahmen war per Link geteilt — der Link gilt nicht mehr. Teile die zusammengeführte Aufnahme neu, wenn du möchtest.",
  "sd.mergeShareGoneN": "{n} der zusammengeführten Aufnahmen waren per Link geteilt — die Links gelten nicht mehr. Teile die zusammengeführte Aufnahme neu, wenn du möchtest.",
  "sd.mergeShareGoneOk": "Verstanden",
  ...
  "home.baPitch": "Nicken",
  "home.baRoll": "Rollen",
  "home.baNotDetected": "nicht erkannt",
  "home.baCadence": "Takt",
  "home.baHeave": "Hub",
  ...
  "account.browseAll": "In Pause und Off-Foil auch die übrigen Seiten durchblättern",
  "account.browseAllHint": "An (Standard): du kommst in jedem Zustand an alle Seiten. Aus: je Zustand nur die hier zugeordneten Screens — aufgeräumter, aber unterwegs nicht mehr alles erreichbar.",
  "account.noLayoutsOfKind": "Noch kein eigener Screen dieser Art angelegt.",
  ...
  "account.waterLockHint": "Beim Pumpen löst Wasser auf dem Display Aktionen aus. Die Sperre nimmt die Berührung weg, bis du eine Taste drückst. „Automatisch“ heißt: die Uhr entscheidet selbst — nur dort, wo man sich damit nicht aussperren kann. Garmin braucht sie nicht.",
  "account.accelWakeup": "Bewegungssensor wach halten (Test)",
  "account.accelWakeupDefault": "Standard ({v})",
  "account.accelWakeupOn": "An",
  "account.accelWakeupOff": "Aus",
  "account.accelWakeupHint": "Manche Wear-OS-Uhren verlieren Bewegungsdaten, wenn sie während der Aufnahme einschlafen – dann fehlen Pumps. „An“ holt sie zurück, kann aber mehr Akku kosten. Noch im Test: probier es aus und stell zurück, falls der Akku leidet. Ab Uhr-Version 1.2.33.",
  ...
  "pumpunit.hint": "Wie die Pump-Kadenz angezeigt wird: in Hz (Pumps pro Sekunde) oder als Pumps pro Minute. Das ändert nur die Anzeige.",
  "pumpunit.hz": "Hz",
  ...
  "sd.exportFit": "Als FIT-Datei herunterladen (für Garmin Connect, Strava & Co.)",
  "sd.exportFail": "Download fehlgeschlagen",
  ...
  "spotnote.invite": "Du warst hier schon foilen — beschreib den Spot für andere: Startstelle, Untergrund, was man wissen sollte.",
  "spotnote.placeholder": "Wie startet man hier? Steg, Beach, Drop-in? Untergrund, Strömung, Parken, Hinweise …",
  "spotnote.addPhoto": "Foto hinzufügen",
  "spotnote.fromSession": "Aus meinen Session-Fotos",
  "spotnote.noSessionPhotos": "Du hast an diesem Spot noch keine Session-Fotos.",
  "spotnote.photos": "Fotos",
  "spotnote.moveLeft": "nach vorn",
  "spotnote.moveRight": "nach hinten",
  "spotnote.none": "Für diesen Spot gibt es noch keine Beschreibung.",
  "spotnote.deleteConfirm": "Eigene Spot-Beschreibung samt Fotos löschen?",
  "spotnote.reportConfirm": "Diese Beschreibung als unangemessen melden?",
  "spotnote.error": "Hat nicht geklappt.",
  ...
  "board.heaveShakyAll": "Über die ganze Aufnahme ist der Hub nicht belastbar: zwischen den Läufen bewegt sich das Brett langsamer als das {s}-Sekunden-Fenster zulässt, und dann wird jeder kleine Fehler stark vergrößert. Die Werte je Lauf unten gelten für sich — unsichere stehen dort in Klammern.",
  "sd.mountSlipped": "Andere Montage als in den übrigen Läufen — das Handy wurde gedreht oder ist verrutscht",
  ...
  "adm.flags.block": "Melden sperren",
  "adm.flags.unblock": "Sperre aufheben",
  ...
  "adm.cls.setSport": "Als Sportart einordnen …",
  "adm.cls.setQuality": "Als Datenproblem einordnen …",
  "adm.usport.title": "Sportart je Nutzer",
  "adm.usport.hint": "Für Nutzer, die auf die Bitte um Zuordnung nicht reagieren. Drei getrennte Aktionen: der Profil-Standard wirkt nur auf KÜNFTIGE Sessions, das Auflösen nur auf die bestehenden Sessions mit offener Aufforderung, und „Alle Sessions setzen“ auf alle bestehenden Sessions, die noch niemand eingeordnet hat — auch ohne Aufforderung. „Pumpfoil“ sperrt die betroffenen Sessions zugleich gegen neue Meldungen.",
  "adm.usport.search": "Nach Anzeigename suchen",
  "adm.usport.none": "Niemand hat offene Aufforderungen.",
  "adm.usport.noMatch": "Kein Nutzer gefunden.",
  "adm.usport.default": "Profil-Standard: {sport}",
  "adm.usport.sessions": "{n} Sessions",
  "adm.usport.open": "{n} offene Aufforderungen",
  "adm.usport.pick": "Sportart wählen …",
  "adm.usport.setDefault": "Als Profil-Standard setzen",
  "adm.usport.resolve": "Offene auflösen ({n} Sessions betroffen)",
  "adm.usport.resolveNone": "Keine offenen Aufforderungen",
  "adm.usport.confirm": "{n} Sessions dieses Nutzers auf „{sport}“ setzen und die Aufforderung entfernen?",
  "adm.usport.doneDefault": "Profil-Standard ist jetzt {sport}.",
  "adm.usport.doneResolve": "{n} Sessions zugeordnet.",
  "adm.usport.setAll": "Alle Sessions setzen ({n} betroffen)",
  "adm.usport.setAllNone": "Keine offenen Sessions",
  "adm.usport.setAllKeep": "Bereits eingeordnete Sessions bleiben unverändert ({k}).",
  "adm.usport.setAllConfirm": "{n} Sessions dieses Nutzers auf „{sport}“ setzen? {k} bereits eingeordnete Sessions bleiben unverändert.",
  "adm.usport.doneSetAll": "{n} Sessions gesetzt, {k} unverändert.",
  "adm.tab.flagged": "Gemeldet (versteckt)",
  "adm.tab.fake": "Unecht-Verdacht",
  "adm.tab.suspect": "Verdächtig",
  ...
  "adm.spotnote.title": "Gemeldete Spot-Beschreibungen",
  "adm.spotnote.none": "Keine gemeldeten Spot-Beschreibungen.",
  "adm.spotnote.showAll": "alle anzeigen",
  "adm.spotnote.onlyReported": "nur gemeldete",
  "adm.spotnote.reported": "gemeldet",
  "adm.spotnote.hidden": "ausgeblendet",
  "adm.spotnote.checked": "geprüft",
  "adm.spotnote.deleteConfirm": "Diese Spot-Beschreibung samt Fotos endgültig löschen?",
  "adm.approve": "Freigeben",
  "adm.hideConfirm": "Shadow-Ban? Für alle anderen unsichtbar — der Besitzer sieht sie weiter normal und merkt nichts. (Sanftere Alternative: Aussortieren.)",
  "adm.hide": "Shadow-Ban",
  ...
  "imp.fb1": "<b>Zugriff:</b> deine E-Mail-Adresse, deinen Vornamen und deine Facebook-Nutzer-ID. Nachname und Profilbild holen wir nicht ab.",
  "imp.fb2": "<b>Verwendung:</b> ausschließlich zum Erstellen und Anmelden deines Pumpfoil-Kontos sowie zur Anzeige deines Vornamens in der App.",
  "imp.fb3": "Es erfolgt <b>kein Zugriff</b> auf weitere Facebook-Daten — keine Freundesliste, keine Beiträge, keine Fotos, keine Seiten.",
  "imp.fb4": "Diese Daten werden <b>nicht an Dritte weitergegeben</b>, nicht für Werbung verwendet und nicht zum Training von KI-/ML-Modellen genutzt.",
  "imp.fb5": "Auf dieser Website läuft <b>kein Facebook-Skript und kein Pixel</b>. Die Anmeldung ist eine Weiterleitung, die erst startet, wenn du den Knopf drückst — vorher hat Facebook mit deinem Besuch nichts zu tun.",
  "imp.fbNote": "Entfernst du pumpfoil.org in deinen Facebook-Einstellungen, löschen wir die Verknüpfung automatisch; dein Pumpfoil-Konto bleibt bestehen. Den Stand einer solchen Anfrage findest du unter <a href=\"/datenloeschung\" class=\"text-brand-400 hover:underline\">Datenlöschung</a>, und dein Konto vollständig löschen kannst du jederzeit selbst im Profil.",
  ...
  "imp.map2": "Schaltest du mit dem Knopf auf der Karte auf <b>Satellit</b>, kommen die Luftbilder von <b>Esri</b> (Esri, Maxar, Earthstar Geographics) — ebenfalls direkt von deren Servern und ebenfalls mit deiner IP-Adresse. Das passiert <b>nur</b>, wenn du umschaltest; deine Wahl wird lokal auf deinem Gerät gemerkt.",
  ...
  "dm.tabBot": "Bot",
  "dm.botNote": "Alle Chats von {name} — nur für Admins, rein lesend. Die Zahl zeigt Nachrichten des Bots von allen im Raum.",
  "dm.botNone": "Der Assistent hat noch nichts geschrieben.",
  "dm.botEmpty": "Keine Nachrichten in diesem Raum.",
  ...
  "adm.feedbackDelAllConfirm": "Wirklich {n} Feedback-Einträge löschen? ⭐-markierte (Testimonials) bleiben erhalten. Das kann nicht rückgängig gemacht werden.",
  "adm.feedbackStarTitle": "Als Testimonial markieren — überlebt 'Alle löschen'. Vor öffentlicher Nutzung den Autor fragen!",
  "login.or": "oder",
  ...
  "land.watchBody": "Eigene Apps für Garmin, Apple Watch, Wear OS und Amazfit mit konfigurierbaren Datenfeldern — Geschwindigkeit, Puls, Distanz, Zeit. Die Aufnahme läuft lokal (auch offline) und wird automatisch synchronisiert.",
  ...
  "land.kann4Body": "25 Messungen pro Sekunde am Handgelenk, 50 am Handy, GPS jede Sekunde, dazu der Puls. Alles bleibt unverändert gespeichert — jede Verbesserung der Auswertung rechnet auch deine alten Sessions neu.",
  ...
  "land.kann6Title": "Offen und fair",
  "land.kann6Body": "Kostenlos, quelloffen (AGPL), ohne Tracking. Deine Daten gehören dir: Export als GPX und FIT, und auf Wunsch liest deine eigene KI sie mit — nur lesend und nur deine.",
  ...
  "land.comm1Body": "Weitester und längster Lauf, Topspeed, längste Gleitphase, meiste Läufe, Pumps und Strecke einer Session, Höchstpuls, Frühaufsteher, Nachteule und Carves — für heute, 10 und 30 Tage, das Jahr und für immer. Weltweit, je Spot und je Foil, mit Push, wenn du einen holst.",
  "land.comm2Title": "Bestenlisten",
  "land.comm2Body": "Die Top 10 nach Sessions, Läufen, Pumps und Spots, filterbar nach Sportart und Foil-Größe — auch „Foils wie meins“. Dazu der Spot-Vergleich: welcher Spot am meisten gefahren wird.",
  "land.comm3Title": "Spotkarte und Spotbeschreibungen",
  "land.comm3Body": "Alle Spots auf der Karte, mit Wetter, Spot-Rekorden und den Sessions dort. Wer an einem Spot fährt, beschreibt ihn für die anderen, mit bis zu zehn Fotos — und schlägt den richtigen Namen vor, wir prüfen und übernehmen ihn.",
  "land.comm4Title": "Chat je Spot",
  "land.comm4Body": "Ein Chatraum für jeden Spot, einer für alle und Direktnachrichten — mit Push, wenn jemand schreibt.",
  "land.comm5Title": "Community-Layouts für die Uhr",
  "land.comm5Body": "Teile deine Datenseiten und übernimm die der anderen mit einem Klick.",
  "land.comm6Title": "Fotos, Videos und Likes",
  "land.comm6Body": "Hänge Fotos und Clips von YouTube, Instagram oder TikTok an deine Session. Likes für Sessions, Fotos und Spot-Beschreibungen, und die meistgelikten Sessions stehen ganz oben.",
  "land.comm7Title": "Deine Session als Bild",
  "land.comm7Body": "Track und Werte als fertiges Bild zum Teilen — auf Karte, Satellitenbild oder deinem eigenen Foto, mit den Zahlen, die du zeigen willst.",
  "land.comm8Title": "Teilen per Link, ohne Anmeldung",
  "land.comm8Body": "Ein Link zeigt die vollständige Auswertung einer Session — Track, Läufe, Puls, Pumps, Ausrüstung —, auch für Leute ohne Konto. Du kannst ihn jederzeit zurückziehen.",
  "land.comm9Title": "Vergleichen",
  "land.comm9Body": "Lege jede Session und jeden Lauf aus der Community neben deine eigenen und spiel sie gleichzeitig ab.",
  "land.comm10Title": "Foiler-Seite und Foil-Datenbank",
  "land.comm10Body": "Deine eigene Seite mit Rekorden, Spots und letzten Sessions — was darauf steht, entscheidest du. Dazu die Foil-Datenbank mit den Maßen der Hersteller.",
  "land.comm11Title": "Uhr verliehen? Session übertragen",
  "land.comm11Body": "Fährt ein Freund ohne eigene Uhr mit deiner, schickst du ihm die Session mit einem Klick — nimmt er an, gehört sie ihm, mit allen Läufen und Rekorden.",
  "land.comm12Title": "Foil- und Uhren-Statistik",
  "land.comm12Body": "Was wird mit welchem Foil gefahren? Top-Speed, weitester Lauf, Pumptakt und Meter je Pump für jedes Foil der Community, mit seinen Rekorden. Und je Uhrenmodell: wie gut GPS, Puls und Pump-Erkennung wirklich sind — bevor du eine kaufst.",
  ...
  "land.f1Body": "Apps für Garmin, Apple Watch, Wear OS und Amazfit nehmen GPS, Puls und rohe Beschleunigung auf — mit konfigurierbaren Datenseiten. Die Aufnahme läuft auch offline und synchronisiert später automatisch.",
  ...
  "linked.xiaomi.hint": "Für Xiaomi gibt es keine eigene Verknüpfung — aber einen offiziellen Umweg: Mi Fitness schickt deine Trainings in die Suunto-App, und von dort holen wir sie ab. Du brauchst dafür ein (kostenloses) Suunto-Konto.",
  ...
  "linked.xiaomi.step2": "Hier oben in der Suunto-Karte auf „Verbinden“ tippen und dasselbe Suunto-Konto verwenden.",
  "linked.xiaomi.step3": "Fahren. Deine Sessions landen danach automatisch bei uns.",
  "linked.xiaomi.note": "Xiaomi bietet diese Verbindung weltweit an, außer in China. Auf der Uhr selbst kann keine App laufen — Xiaomi lässt fremde Apps nicht zu.",
  "land.connectXiaomi": "über Mi Fitness + Suunto",
  "watches.nXiaomi": "Keine App auf der Uhr möglich (Xiaomi lässt keine fremden Apps zu). Dafür schickt Mi Fitness deine Trainings offiziell in die Suunto-App — verknüpfe Suunto und sie landen bei uns. Anleitung unter „Konten verknüpfen“.",
  ...
  "alarm.markHint": "0 schaltet ab. Gezählt wird je Lauf, ab dem ersten erkannten Meter — außerhalb eines Laufs passiert nichts.",
  ...
  "foilStats.clickHint": "Tippe auf ein Foil, um seine Rekorde und alle Sessions damit zu sehen.",
  "foilDetail.title": "Foil",
  "foilDetail.records": "Community-Rekorde mit diesem Foil",
  "foilDetail.community": "{sessions} Sessions von {users} Fahrern",
  "foilDetail.sessions": "Sessions mit diesem Foil",
  "foilDetail.none": "Mit diesem Foil ist noch keine Session aufgezeichnet.",
  "foilStats.none": "Noch keine Sessions mit gewähltem Foil.",
  "foilStats.onlyBoard": "Nur Aufnahmen mit dem Handy am Brett",
  "foilStats.noneBoard": "Noch keine Aufnahmen mit dem Handy am Brett und gewähltem Foil.",
  ...
  "settings.sync.why.later": "{n} wird später erneut versucht",
  ...
  "settings.sync.nothingNew": "Nichts Neues",
  "settings.sync.imported": "{n} importiert",
  "settings.sync.progress": "{fertig} von {gesamt} Trainings",
  "settings.sports.title": "Welche Sportarten importieren?",
  "settings.sports.hint": "Hier stehen nur die Modi, die dein Konto bisher wirklich geliefert hat — kommt ein neuer dazu, wird er automatisch importiert, bis du ihn abwählst. Gilt für künftige Importe.",
  "settings.sports.none": "Noch keine. Sobald eine Aktivität übertragen wurde, erscheint ihr Modus hier.",
  "settings.sports.saved": "Gespeichert",
  "settings.coros.help2": "Auf der Uhr eine Outdoor-Aktivität mit GPS aufnehmen. Nach unseren Messungen liefert „Flatwater“ die besten Daten (1 Punkt pro Sekunde, Geschwindigkeit und Puls vollständig). Indoor/ohne GPS wird übersprungen.",
  ...
  "account.offFoilTitle": "Wenn du gerade nicht foilst",
  "account.offFoilDesc": "Zeigt die Uhr, sobald ein Lauf endet und solange du nicht fährst — also auch beim Dümpeln zwischen den Läufen. Die Aufnahme läuft dabei weiter.",
  "foils.toSetup": "Detailliertes Setup",
  "setup.title": "Detailliertes Setup",
  "setup.hint": "Stab, Mastlänge, Shim und Boards — genau wie bei den Foils: markieren, was du besitzt, einen Standard setzen (Stern), und je Session umstellen. Rein informativ, es wird nichts damit gerechnet.",
  ...
  "setup.shimDesc": "Deine Shims in Grad — negativ, 0 oder positiv (z. B. −1, 0, +0,5, +2). Halbe und Zehntelgrade sind erlaubt.",
  "setup.shimPlaceholder": "z. B. +1,5",
  "setup.boardTitle": "Boards",
  "setup.boardDesc": "Deine Boards trägst du selbst ein (Name, optional Volumen und Länge) — dafür gibt es keinen Hersteller-Katalog.",
  ...
  "setup.stabCatalogEmpty": "Für diese Suche ist nichts in der Liste — leg die Bezeichnung einfach selbst an.",
  "setup.ownStab": "eigener Eintrag (nur für dich sichtbar)",
  "setup.stabAddHint": "Nicht dabei? Bezeichnung selbst anlegen — sie ist erstmal nur für dich sichtbar, gute Einträge übernehmen wir später in die allgemeine Liste.",
  "setup.stabBrandPlaceholder": "Marke",
  "setup.stabModelPlaceholder": "Modell (z. B. Stab Trail)",
  "setup.stabSizePlaceholder": "Größe",
  "setup.stabAddErr": "Konnte nicht angelegt werden — diese Bezeichnung ist schon vergeben.",
  "setup.stabDelConfirm": "Diesen eigenen Eintrag löschen? Sessions, die ihn nutzen, fallen zurück auf deinen Standard.",
  ...
  "account.pauseDesc": "Zeigt die Uhr nur, wenn du die Aufnahme selbst pausiert hast (STOP halten → Pausieren). Eigene Screens dieser Art enthalten immer den „Pausiert“-Hinweis — verschiebbar, aber nicht entfernbar, sonst weiß niemand, wie er fortsetzt.",
  ...
  "cls.notPumpfoil": "Sieht nicht nach Pumpfoil aus",
  ...
  "cls.autoAsk": "Diese Session sieht für uns nicht nach Pumpfoiling aus — deshalb zählt sie vorerst in keiner Auswertung mit. Magst du sie richtig zuordnen? War es doch Pumpfoiling, wähle einfach „Pumpfoil“.",
  "cls.autoSetAs": "Automatisch eingeordnet als {sport}. Stimmt das nicht, ändere es einfach hier.",
  "cls.autoWhy": "Ausschlaggebend: längster Lauf {dur} s bei Ø {kmh} km/h — beim Pumpen dauert ein Lauf im Mittel 27 s.",
  "cls.autoWhyPulse": "Ausschlaggebend: längster Lauf {dur} s bei Ø {kmh} km/h, und der Puls reagierte kaum ({hr} bpm).",
  ...
  "lay.empty": "Noch kein Layout in dieser Kategorie.",
  ...
  "lay.copy": "Kopieren",
  "lay.delConfirm": "Dieses Layout löschen?",
  "lay.saveErr": "Konnte nicht gespeichert werden.",
  "lay.notFound": "Layout nicht gefunden.",
  "lay.backToList": "Zurück zur Übersicht",
  "lay.notOnWatchYet": "Die Uhr zeigt diese Layouts noch nicht — sie werden hier vorbereitet, die Uhr-Unterstützung kommt in einem der nächsten Updates. Deine bestehenden 3-Feld-Ansichten laufen unverändert weiter.",
  ...
  "lay.catDesc.off_foil": "Die kurze Zusammenfassung direkt nach einem Lauf.",
  "lay.catDesc.pause": "Was die Uhr zeigt, während du zwischen zwei Läufen dümpelst.",
  "lay.maxElements": "Mehr Elemente passen nicht auf eine Seite.",
  "lay.newText": "Text",
  "lay.dragHint": "Element antippen und ziehen, um es zu platzieren. Die Uhrengröße oben ist nur zum Prüfen — beim Speichern merken wir sie als „entworfen für“.",
  ...
  "lay.lineH": "Waagerecht",
  "lay.lineV": "Senkrecht",
  "lay.lineFree": "Frei/diagonal",
  "lay.lineLength": "Länge",
  "lay.lineHint": "Linie ziehen verschiebt sie ganz; die beiden Punkte an den Enden ziehen sie frei.",
  "lay.pausedHint": "Pausiert",
  "lay.pausedFixed": "Pflicht-Hinweis — verschiebbar, nicht entfernbar",
  "hrz.title": "Puls-Zonen",
  "hrz.hint": "Grundlage für die Farben der Puls-Anzeige auf der Uhr — Zahl UND Grafik. Der Vorschlag kommt aus deinem höchsten je gemessenen Puls; passe ihn an, wenn du deine Zonen kennst.",
  "hrz.z1": "Z1 Erholung",
  "hrz.z2": "Z2 Grundlage",
  "hrz.z3": "Z3 Tempo",
  "hrz.z4": "Z4 Schwelle",
  "hrz.z5": "Z5 Maximum",
  "hrz.bound": "Grenze {n}",
  "hrz.isSuggestion": "Vorschlag aus deinem gemessenen Höchstpuls ({max} bpm). Ändere eine Zahl, dann gilt deine Einstellung.",
  ...
  "spz.z5": "Z5 Maximum",
  "spz.bound": "Grenze {n}",
  "spz.isSuggestion": "Vorschlag aus deiner gefahrenen Geschwindigkeit (bis {max} km/h). Ändere eine Zahl, dann gilt deine Einstellung.",
  ...
  "lay.arcLen": "Länge",
  "lay.arcHint": "Auf runden Uhren ein Ring am Rand, auf eckigen ein Rahmen — die Uhr passt es selbst an. Ziehen verschiebt den Startpunkt entlang des Randes.",
  "lay.barWidth": "Breite",
  ...
  "lay.lineX2": "Ende X",
  "lay.lineY2": "Ende Y",
  "lay.warnTitle": "Auf der kleinsten Uhr ({size}) könnte es eng werden",
  "lay.warnOverflow": "„{text}“ läuft über den Rand.",
  "lay.warnChars": "Diese Zeichen kann die Uhr nicht darstellen: {chars}",
  "lay.type.1": "Wert",
  "lay.type.2": "Label",
  ...
  "spotRename.hint": "Spot-Namen kommen automatisch vom nächstgelegenen Ort und treffen oft nicht das, was die Leute vor Ort sagen. Schick uns deinen Vorschlag — wir schauen ihn uns an und ändern den Namen dann von Hand. Er gilt für alle, die hier fahren.",
  "spotRename.current": "Jetziger Name",
  "spotRename.proposed": "Dein Vorschlag",
  "spotRename.reason": "Warum? (freiwillig)",
  "spotRename.send": "Vorschlag senden",
  "spotRename.sent": "Danke! Dein Vorschlag ist bei uns. Wir sehen uns jeden einzeln an.",
