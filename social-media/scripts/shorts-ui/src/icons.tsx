...
export const ICON_PATHS: Record<string, string> = {
  ...
  eyeoff: "m3 3 18 18M10.6 10.6a3 3 0 0 0 4.2 4.2M9.6 5.2A9.6 9.6 0 0 1 12 5c6.4 0 10 7 10 7a17 17 0 0 1-3.3 4.1M6.4 6.4A17 17 0 0 0 2 12s3.6 7 10 7a9.7 9.7 0 0 0 3.6-.7",
};
