...
|---|---|---|---|
| 2026-09-26 vormittags | iOS + Apple Watch (App Store) | 1.1.38 (42) | 🟡 **EINGEREICHT.** Jans Meldung: „das android und ios eingereicht wurden“. Inhalt: der Nachzug der PWA (Brettlage mit FoilRig, Privatsphaere, Einstellungen je Uhr, MCP, Vergleich 1×, Puls-Regler, Spot-Namensvorschlag, Abzeichen „am Brett“, Foil-Stats-Filter, Wetter), Apple Watch: Pause neben Verwerfen, Pausen-Seiten, Seiten je Zustand wie Garmin. Die Seiten-Umstellung war auf der VM nur `swiftc -parse`-geprueft; der erste Typcheck lief in Jans Xcode. |
