...
|---|---|---|---|
| 2026-09-26 08:42 | iOS + Apple Watch (App Store) | 1.1.38 (42) | ✅ **LIVE 26.09. 19:02 Berlin** — Apple-Mail „ready for distribution · 1.1.38 · iOS“, gegengeprueft an der Store-API (de/us/gb/ch/at: 1.1.38, currentVersionReleaseDate 2026-09-26T17:02:09Z); rund zehn Stunden Pruefung. `_APP_META` ios/apple auf 1.1.38, IN_REVIEW raus, Changelog: drei Apple-Watch-Punkte (468–470, `versionen={apple}`) + Freigabe-Ereignis 471; die 16 PWA-Portierungen NICHT wiederholt (stehen schon als Web-Punkte). — Vorher: 🟡 **EINGEREICHT.** App Store Connect: „iOS-Übermittlung · Warten auf Prüfung“, iOS-App 1.1.38 (42), Übermittlungsdatum 26. Sept. 2026 um 08:42 Uhr, Übermittlungskennung `93f72622-8469-4221-a258-60f70d1288ac`. **⚠️ Fehler von mir:** schon um ~08:37 als eingereicht eingetragen (Changelog-Ereignis 467, IN_REVIEW, diese Zeile), weil ich „das android und ios eingereicht wurden fehlt auch noch“ als Meldung las — es war keine. Fuenf Minuten lang stand oeffentlich eine Einreichung, die es noch nicht gab. Inhalt: der Nachzug der PWA (Brettlage mit FoilRig, Privatsphaere, Einstellungen je Uhr, MCP, Vergleich 1×, Puls-Regler, Spot-Namensvorschlag, Abzeichen „am Brett“, Foil-Stats-Filter, Wetter), Apple Watch: Pause neben Verwerfen, Pausen-Seiten, Seiten je Zustand wie Garmin. Die Seiten-Umstellung war auf der VM nur `swiftc -parse`-geprueft; der erste Typcheck lief in Jans Xcode. |
| 2026-09-26 ~08:30 | Android Phone + Wear OS (Play) | 1.1.33 (47) / 1.2.33 (1043) | 🟡 **EINGEREICHT.** Play Console: „Änderungen, die überprüft werden — Schnelle Vorabprüfungen … Noch maximal 14 Minuten“, Produktion 47 (1.1.33) und Produktion (Wear OS) 1043 (1.2.33), verwaltete Veröffentlichung (Jan startet den Roll-out selbst). Zuletzt veröffentlicht 25.09. Inhalt Phone: Brettlage-Ansicht mit FoilRig, Frage „Handy am Brett?“, Brettlage auf der Startseite, Ort ausblenden, geteilte Links, öffentliche Foiler-Seite, Einstellungen je Uhr, MCP-Karte, Vergleich 1×, Puls-Regler, Vergleichsknopf, Spot-Namensvorschlag, Abzeichen „am Brett“, Foil-Stats-Filter, Wetter unter den Sessions, Farbpalette ohne Lila. Inhalt Wear: Wake-up-Sensor (Standard aus, je Uhr schaltbar), Pause neben Verwerfen, Pausen-Seiten + „Pausiert“, Seiten je Zustand wie Garmin (keine Übersicht mehr). Getestet: Jan am Emulator, Sessions #10132 (2,5 min, 29/29 Chunks) und #10133, beide `exact_chunks`, ~25 Hz — **kein langer Lauf, kein erzwungener Doze.** |
| 2026-09-26 (Freigabe) | Garmin (Connect IQ) | 1.0.90 | ✅ **LIVE, am Store belegt:** Produktseite und Store-API `latestExternalVersion` 1.0.90 / intern 44 (zuerst noch 1.0.89/43, der Store brauchte eine Weile). `_APP_META["garmin"]` auf 1.0.90, IN_REVIEW-Eintrag raus. Changelog-Zeilen 461–463 (`versionen={garmin: 1.0.90}`) + Freigabe-Ereignis 464 eingetragen (mit Jans OK). `watch/bin` nach Jans OK neu gebaut: 129 von 129, 0 Fehler, `/api/app/devices` meldet 129× 1.0.90 (8 Schwarz-Weiss-Uhren mit bpp 1). — Vorher: 🟡 **EINGEREICHT, Freigabe NICHT belegt.** Jans Meldung: „habe die 1.0.90 aus dem iq store auf meine echte uhr installiert und 5 sekunden testsession hochgeladen erfolgreich“ — Session #10131 (`app_version 1.0.90`, analyzed), Token 297 (fenix 7X Pro) meldet 1.0.90. **Aber** um ~07:50 UTC nannten Produktseite UND Store-API noch `latestExternalVersion` 1.0.89 / intern 43. Dieselbe Uhr hatte am Morgen die Test-`.prg` 1.0.90 bekommen, die Session belegt also nicht, woher die App kommt. Deshalb nach IN_REVIEW statt live; `_APP_META["garmin"]` bleibt 1.0.89 und `watch/bin` unveraendert, bis der Store 1.0.90 selbst nennt. **Paket:** `/home/jan/release-staging/garmin-1.0.90/pumpfoil-1.0.90.iq`, **14.126.681 B**, sha1 `e81d684135a8247a961e7bdc775182d5b37ae921`, md5 `e7f1c2fb4f9b02bc1b49de09d4639e46`, **218 von 218 Geraeten, 0 Fehler**, aus Commit `7302a937`, nach Ende von `monkeyc` nachgemessen. Inhalt: Seiten-Saetze + „alle Seiten“ fuer die 128-KB-Klasse (Instinct 3 Solar u. a.), Schwarz-Weiss-Uhren weiss statt schwarz, Instinct-3-Seiten unter dem Nebendisplay. |
| 2026-09-25 (Freigabe) | Android Phone + Wear OS (Play) | 1.1.32 / 1.2.32 | ✅ **FREIGEGEBEN UND LIVE.** Play-Mail: „Your update to Pumpfoil, created on Sep 24, 2026 at 9:05 AM GMT, is live in the store." Passt auf unsere Einreichung vom 24.09. 11:05 Berlin (Jans Meldung an dem Tag: „android ist schon hochgeladen und zur pruefung eingereicht"). ⏱️ **EINEN TAG Pruefung**, wie schon bei 1.1.31 — die drei davor brauchten je drei. Wie immer deckt EINE Mail beide Spuren ab. `appmeta` auf 1.1.32 / 1.2.32, IN_REVIEW-Eintrag raus. **Von den SECHS eingereichten Punkten sind nur VIER in den Changelog gewandert**, und einer davon nicht als eigene Zeile: der Meilenstein-Puls (24.09.) und „Foil Scoot" (25.09.) standen schon OHNE Versionen drin und gelten damit fuer alle — ein zweites Mal mit Play-Version waere derselbe Satz doppelt. „An interrupted upload picks itself up when you open the app again." stand wortgleich schon mit `{ios, apple}` da (id 447) und hat `android`/`wear` DAZU bekommen, statt eine zweite Zeile zu erzeugen; das Skript hat die Dublette selbst erkannt und uebersprungen. Die drei uebrigen stehen als eigene Zeilen mit `versionen={android, wear}` — bewusst neben den iOS-Zeilen vom selben Tag, weil es zwei getrennte Auslieferungen sind (genau so schon beim Gyroskop-Punkt am 21./22.09.). **Damit liegt nur noch EINE Pruefung:** Amazfit 1.0.12 im Zepp-Store. |
| 2026-09-25 00:42 (Freigabe) | iOS + Apple Watch (App Store) | 1.1.37 | ✅ **FREIGEGEBEN UND LIVE.** ZWEITE Apple-Mail („The following app is ready for distribution · App Version Number: 1.1.37 · Platform: iOS“), eingegangen am Morgen des 25.09. **Nicht nur die Mail geglaubt:** die Store-API meldet in **de/gb/ch** uebereinstimmend 1.1.37 mit `currentVersionReleaseDate` 2026-09-24T22:42:13Z (= 25.09. 00:42 Berlin); **us** hing zu dem Zeitpunkt noch auf 1.1.36 vom 21.09. — der bekannte Cache-Nachhang einer einzelnen Storefront, kein Grund zu warten (so schon bei 1.1.35 und 1.1.31). **EINGEREICHT 24.09. 11:32, freigegeben 25.09. 00:42 — rund DREIZEHN Stunden Pruefung**, im Rahmen der letzten Vorgaenge (9,5 h bei 1.1.36, 11 h bei 1.1.33). `appmeta` auf 1.1.37 gesetzt (beide Schluessel `ios` und `apple`, ein Bundle), der IN_REVIEW-Eintrag raus, fuenf Changelog-Punkte und ein Freigabe-Ereignis auf den **25.09.** datiert (Tag der Auslieferung, nicht der Einreichung). **Zwei der sechs eingereichten Punkte stehen dort bewusst anders:** der Meilenstein-Puls war schon am 24.09. als versionsloser Web-Punkt drin (derselbe Satz zweimal waere Rauschen), und „Foil Scoot“ bekam KEINE Version, weil die Sportart seit dem 22.09. (`c655d596`) ohnehin in Web und Server steckt und nur nie angekuendigt wurde — mit iOS-Version davor haetten Web-Nutzer gelesen, sie braeuchten dafuer die iPhone-App. Die uebrigen vier tragen `versionen={ios,apple}`. **Damit liegen noch zwei Pruefungen:** Android/Wear 1.1.32 / 1.2.32 bei Google und Amazfit 1.0.12 im Zepp-Store. |
| 2026-09-24 11:32 | iOS + Apple Watch (App Store) | 1.1.37 | 🟡 **EINGEREICHT.** App Store Connect: Uebermittlung „iOS 1.1.37“, 1 Element, Status „Warten auf Pruefung“; die 1.1.36 darueber steht auf „Pruefung abgeschlossen“. Inhalt: Foil Scoot als Sportart, Meilenstein-Puls auf den Community-Zahlen, **Pause mit Teil-Upload auf der Apple Watch**, Profil-Abgleich direkt nach dem Upload, und die **Upload-Leiste des Handy-Recorders** (`PhoneUploadBar.swift`, neu) samt `drain()` beim App-Start und bei Rueckkehr aus dem Hintergrund. Die Leiste entstand am selben Tag aus Jans Frage, warum der Fortschrittsbalken nirgends im Changelog stehe: auf Android war er nur noch nicht freigegeben, auf iOS gab es ihn gar nicht (`uploadSent`/`uploadTotal` fehlten, und `drain()` stiess nur RecordView an). Vor dem Bauen auf der VM geprueft, soweit moeglich: `swiftc -parse` ueber alle vier geaenderten Dateien sauber, Member gegen die Deklarationen abgeglichen; der Typcheck lief erst in Jans Xcode. `xcodegen generate` war noetig (neue Datei). **Damit liegen alle vier Plattformen gleichzeitig im Review** — iOS bei Apple, Android/Wear bei Google, Amazfit beim Zepp-Store; Garmin 1.0.89 ist am selben Tag schon durch. NAECHSTES ist leer, die Seite blendet den Abschnitt aus; was danach kommt, steht seit heute unverbindlich unter „Ideas for future development“. |
| 2026-09-24 (Freigabe) | Garmin (Connect IQ) | 1.0.89 | ✅ **EINGEREICHT UND AM SELBEN TAG LIVE.** Jans Meldung: „garmin 1.0.89 ist im store verfuegbar, habe meine echte uhr ueber den iq store geupdated und eine testsession schon hochgeladen“; Store-Seite „Latest Release September 24, 2026 · Version 1.0.89 · Size 77 KB“. **Wieder Minuten statt Tage** — bei Garmin der Normalfall. **DREIFACH belegt, nicht nur die Meldung:** `latestExternalVersion` 1.0.89 / `latestInternalVersion` 43 auf der Produktseite, Jans physisches Geraet (Token 297, 006-B4376-00, fenix 7X Pro) und ein zweites (Token 1154, 006-B3888-00) melden `1.0.89`, dazu Sessions ab 11:10. Eine echte Uhr bekommt eine neue Version nur ueber den Store. **Paket:** `/home/jan/release-staging/garmin-1.0.89/pumpfoil-1.0.89.iq`, **14.117.122 B**, sha1 `29464ce4e3e37bcc687a7f0e7bdd746bc7241d89`, md5 `5bcad5431ab2846884dd4f2744d9b422`, **218 von 218 Geraeten, 0 Fehler** (19.421 Warnungen, dieselben Container-Typ-Hinweise wie immer). Gebaut mit `monkeyc -e -w` aus Commit `23e8b666`; Store-Notizen deu/eng liegen als `store-notizen.txt` daneben. **⚠️ Beim Messen aufgepasst:** die erste Groessen- und Hash-Angabe war aus einer noch im Schreiben befindlichen Datei (5,4 MB, `file` sagte nur „data“ statt „7-zip archive“). Erst messen, wenn kein `monkeyc`-Prozess mehr laeuft. Inhalt: Profil-Abgleich direkt nach einem fertigen Upload statt erst beim naechsten App-Start; von Jan im Emulator gefahren (fenix 7X Pro: Uhr englisch und ungepairt, nach dem Pairing standen Sprache und Screens sofort richtig, ohne Neustart). Kette komplett: `watch/bin` traegt 1.0.89 seit 07:13 (129 von 129), `_APP_META["garmin"]` auf 1.0.89 (Update-Hinweis laeuft, `/api/app/latest?platform=garmin` gegengeprueft), NAECHSTES-Eintrag raus, Changelog-Punkt mit `versionen={garmin}` plus Freigabe-Ereignis. |
| 2026-09-24 | Android Phone + Wear OS (Play) | 1.1.32 / 1.2.32 | 🟡 **EINGEREICHT** (Jans Meldung: „android ist schon hochgeladen und zur pruefung eingereicht“, davor „habs grad getestet“). Inhalt Handy: Foil Scoot als Sportart, **Upload-Leiste des Handy-Recorders** (`PhoneUploadBar.kt`, ueberall sichtbar statt nur im Aufnahme-Bildschirm), abgebrochener Upload laeuft beim naechsten App-Start weiter, Meilenstein-Puls auf den Community-Zahlen. Wear: **Pause mit Teil-Upload** und Profil-Abgleich direkt nach dem Upload. **⚠️ MIT EINEM ANZEIGEFEHLER DRIN, bewusst:** `PhoneUploadBar.kt:61` ruft `I18n.t("upload.progressPct")`, und den Schluessel gab es in KEINER Sprachtabelle — `I18n.t` endet bei `S[key] ?: return key`, auf dem Balken stand also woertlich „upload.progressPct“ statt „45 % · 12/27“. Der Balken selbst stimmt (`uploadSent`/`uploadTotal` sind echte Zahlen), es ist reine Anzeige. Gefunden NACH dem Upload; Jan: „ist mir egal solange es nur ein anzeigefehler ist“ → Schluessel nachgetragen, geht mit 1.1.33 mit. **Lehre fuer die naechste neue Textzeile:** ein Schluessel ohne Tabellen-Eintrag faellt auf Android NICHT auf Englisch zurueck, sondern zeigt sich selbst. |
| 2026-09-24 | Zepp / Amazfit | 1.0.12 (code 15) | 🟡 **EINGEREICHT.** Zepp-Konsole: appId 1118995, Pumpfoil, free, 1.0.12, Application Time 2026.09.24, Status „Under Review (Can be Withdrawn)“; daneben 1.0.11 vom 2026.09.21 weiter „Approved“. **Der Build ist der erste, der durch `npm run build` statt `zeus build` ging** (s. `zepp.mjs`): `DEV_FAKE_GPS = false` erzeugt, `app.json` und `APP_VERSION` beide 1.0.12, und die Nachpruefung am fertigen `.zab` meldet „echter GPS-Pfad in 12 von 24 kompilierten Dateien, Fake-Zweig zusaetzlich in 12“. Die zweite Zahl ist KEIN Befund: bei `false` laesst Rollup beide Zweige stehen, die Konstante entscheidet zur Laufzeit. Der Unterschied zum zurueckgezogenen 1.0.11 vom 18.09. ist die ERSTE Zahl — damals war `getLatitude` in **0** Dateien, weil der Bundler bei `true` den echten Pfad wegoptimiert hatte. Inhalt: die 10 Punkte aus `appmeta`, darunter **Pause mit Teil-Upload** und **Verwerfen ohne zu speichern**. **Beides am selben Tag auf der T-Rex 3 gegengeprueft**, nachdem der erste Pause-Entwurf beim Fortsetzen die laufende Aufnahme geloescht hatte (Session #9739: 1237 s Wanduhr, 3 GPS-Punkte) — Fix `6c15281a`, Beleg Session #9742: 733 s Wanduhr, zwei Pausen, 391 Punkte und 6132 Samples lueckenlos, `time_base = exact_chunks`. Die Icon-Warnung („needs to be 248“) kam wie bei jedem Build seit 1.0.6, ohne Folgen. `appmeta` von NAECHSTES nach IN_REVIEW gezogen mit `"eingereicht": "2026-09-24"`, Server neu gestartet, `/api/app/releases` gegengeprueft („submitted 24 September, waiting for the Zepp store“). **Nebenbefund aus der Konsole:** die Geraeteliste der Einreichung umfasst jetzt **84 Eintraege** und darunter Modelle, die wir nirgends nennen — Balance 3 / 3 Ti, Balance Ultra, Bip Max, Active 3 Premium, Active Max, Cheetah 2 Pro, T-Rex Ultra 2, T-Rex 3 Pro (44/48 mm), Balance 2 XT. Vor einer Aussage dazu die Liste gegen `docs/ROADMAP.md` abgleichen. |
...
- **🟢 25.09. — MCP-Server mit eigenem OAuth-Autorisierungsserver. FERTIG UND IM ECHTEN EINSATZ.**
  ...
  (Werkzeuge), Zustimmungsseite `web/src/pages/OAuthConsent.tsx`, Liste der verbundenen Programme
  im Profil unter „Verknuepfte Konten". Tests in `tests/test_mcp.py`.

  **Die Grenze** (Jan, woertlich: „NUR LESEND, NUR EIGENE SESSIONS … auch keine aussortierten
  sessions oder geloeschte") steht in EINER Abfrage, `mcp._eigene()`. Jedes Werkzeug baut darauf
  auf, keines fragt selbst. Ausfuehrlich in der Memory `mcp-server-scope` — dort steht auch,
  warum „oeffentlich" bei uns „fuer angemeldete Nutzer" heisst und nicht „fuer fremde Firmen".

  **Sechs Werkzeuge:** `get_overview` (Einstieg: was gibt es, und mit welchen Werten fragt man
  danach), `list_sessions`, `get_session`, `get_board_attitude`, `get_stats`, `list_equipment`.
  Kontingent 200 Aufrufe je Stunde und Nutzer, zweite Stufe 20 je Minute.

  **Vier Dinge, die erst der ECHTE Einsatz gezeigt hat** — jedes davon haette man am Schreibtisch
  nicht gefunden, und jedes ist ein Muster fuer das naechste Mal:
  1. **Die Lage-Daten kamen nie an.** Ich hatte den Aufruf im Plan und nicht gebaut; die Zahlen
     gab es laengst. Jetzt `get_board_attitude`, und `get_session` ZEIGT DARAUF, statt zu
     schweigen — ein Agent soll nicht schliessen muessen, was da ist.
  2. **Der beste Lauf fehlte in der Liste.** Der Agent rief deshalb ueber fuenfzig Mal
     `get_session` auf, nur fuer eine Zahl, die als Spalte in derselben Analyse-Zeile steht.
     Jetzt traegt jede Listenzeile `bester_lauf_*`: aus 50 Aufrufen wurden 6 Seiten.
  3. **Das Kontingent kappte die VERBINDUNG.** Ein blankes HTTP 429 sieht fuer einen MCP-Client
     aus wie ein kaputter Server. Werkzeug-Fehler gehoeren als gewoehnliche Antwort mit
     `isError` zurueck, dann wartet das Modell, statt den Server wegzuwerfen.
  4. **Die Lage-Rechnung war teuer** (80-433 ms, wachsend mit der Zahl der Laeufe). Jetzt in der
     DB zwischengespeichert, Schluessel = Fingerabdruck der Eingaben, danach 2 ms.

  **Noch offen, braucht Jans OK:** Nicken und Rollen als RATE in Grad je Sekunde. Wir liefern
