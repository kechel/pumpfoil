...
private val NB: Map<String, String> = mapOf(
    ...
    "rec.gpsStale" to "GPS frosset – la mobilen ligge",
    "rec.hrPassive" to "Puls passiv",
    "rec.gpsStaleTap" to "Trykk for å lukke",
    ...
    "rec.hrNone" to "Ingen puls registrert – sitter klokka stramt nok?",
    "rec.hrNoneOff" to "Ingen puls: klokka startet ikke målingen.",
    "rec.touchLock" to "Berøringslås",
    "rec.holdFree" to "Hold 2 s = berøring fri",
    ...
    "f.bpm" to "bpm",
    "f.bpmVor" to "for {0} siden",
    "f.bpmKein" to "ingen puls",
...
private val S: Map<String, Map<String, String>> = mapOf(
    ...
    // beiden Uhren gleich heisst.
    "rec.pause" to row("Pausieren", "Pausiere", "Pausieren", "Pause", "Pause", "Pausa", "Pausar"),
    "rec.resume" to row("Fortsetzen", "Fortsetze", "Fortsetzen", "Resume", "Reprendre", "Riprendi", "Reanudar"),
    // Pairing
    ...
    "rec.hrNone" to row("Kein Puls aufgezeichnet – sitzt die Uhr fest genug?", "Kei Puls ufzeichnet – sitzt d Uhr fescht gnueg?", "Kein Puls aufgezeichnet – sitzt die Uhr fest genug?", "No heart rate recorded – is the watch tight enough?", "Aucun pouls enregistré – la montre est-elle assez serrée ?", "Nessun battito registrato – l'orologio è abbastanza stretto?", "Sin pulso registrado – ¿el reloj está bien ajustado?"),
    "rec.hrNoneOff" to row("Kein Puls: die Uhr hat die Messung nicht gestartet.", "Kei Puls: d Uhr het d Messig nöd gstartet.", "Kein Puls: die Uhr hat die Messung nicht gestartet.", "No heart rate: the watch didn't start measuring.", "Aucun pouls : la montre n'a pas lancé la mesure.", "Nessun battito: l'orologio non ha avviato la misurazione.", "Sin pulso: el reloj no inició la medición."),
    "rec.touchLock" to row("Touch-Sperre", "Touch-Sperri", "Touch-Sperre", "Touch lock", "Verrou tactile", "Blocco touch", "Bloqueo táctil"),
    "rec.holdFree" to row("2 s halten = Touch frei", "2 s halte = Touch frei", "2 s halten = Touch frei", "Hold 2 s = touch free", "2 s = tactile libre", "2 s = touch libero", "2 s = táctil libre"),
    ...
    "f.bpmVor" to row("vor {0}", "vor {0}", "vor {0}", "{0} ago", "il y a {0}", "{0} fa", "hace {0}"),
    "f.bpmKein" to row("kein Puls", "kei Puls", "kein Puls", "no pulse", "pas de pouls", "nessun battito", "sin pulso"),
...
private val PT: Map<String, String> = mapOf(
    ...
    "rec.pause" to "Pausar",
    "rec.resume" to "Retomar",
    "rec.hrPerm" to "Sem batimentos: falta a permissão – toque",
    "rec.hrNone" to "Sem batimentos registados – o relógio está bem apertado?",
    "rec.hrNoneOff" to "Sem batimentos: o relógio não iniciou a medição.",
    "rec.touchLock" to "Bloqueio do toque",
    "rec.holdFree" to "2 s = toque livre",
    ...
    "rec.gpsStale" to "GPS congelado – deixe o telemóvel",
    "rec.hrPassive" to "FC passiva",
    "rec.gpsStaleTap" to "Toque para fechar",
...
private val JA: Map<String, String> = mapOf(
    ...
    "rec.hrNone" to "心拍を記録できませんでした – 時計はしっかり装着されていますか？",
    "rec.hrNoneOff" to "心拍なし：時計が測定を開始しませんでした。",
    "rec.touchLock" to "タッチロック",
    "rec.holdFree" to "2秒長押しでタッチ解除",
    ...
    "rec.gpsStale" to "GPS が更新されません – スマホを置いて",
    "rec.hrPassive" to "心拍 受動",
    "rec.gpsStaleTap" to "タップで閉じる",
    "rec.saving" to "保存中…",
...
private val ZH: Map<String, String> = mapOf(
    ...
    "rec.hrNone" to "未记录心率 – 手表戴得够紧吗？",
    "rec.hrNoneOff" to "无心率：手表未开始测量。",
    "rec.touchLock" to "触摸锁定",
    "rec.holdFree" to "长按2秒解锁触摸",
    ...
    "rec.gpsStale" to "GPS 已冻结 — 请把手机放远",
    "rec.hrPassive" to "心率 被动",
    "rec.gpsStaleTap" to "点按关闭",
    "rec.saving" to "保存中…",
...
private val RU: Map<String, String> = mapOf(
    ...
    "rec.paused" to "Пауза",
    "rec.pause" to "Пауза",
    "rec.resume" to "Продолжить",
    "rec.hrPerm" to "Нет пульса: нет разрешения – нажмите",
    "rec.hrNone" to "Пульс не записан – ремешок достаточно затянут?",
    "rec.hrNoneOff" to "Нет пульса: часы не запустили измерение.",
    "rec.touchLock" to "Блокировка касаний",
    "rec.holdFree" to "2 с = касания вкл.",
    ...
    "rec.gpsStale" to "GPS завис — оставь телефон",
    "rec.hrPassive" to "Пульс пассивно",
    "rec.gpsStaleTap" to "Нажми, чтобы скрыть",
...
private val ID: Map<String, String> = mapOf(
    ...
    "rec.pause" to "Jeda",
    "rec.resume" to "Lanjut",
    "rec.hrPerm" to "Tanpa detak jantung: izin belum ada – ketuk",
    "rec.hrNone" to "Detak jantung tidak terekam – apakah jam sudah cukup kencang?",
    "rec.hrNoneOff" to "Tanpa detak jantung: jam tidak memulai pengukuran.",
    "rec.touchLock" to "Kunci sentuh",
    "rec.holdFree" to "2 s = sentuh bebas",
    ...
    "rec.gpsStale" to "GPS beku – tinggalkan ponsel",
    "rec.hrPassive" to "Nadi pasif",
    "rec.gpsStaleTap" to "Ketuk untuk menutup",
...
private val PL: Map<String, String> = mapOf(
    ...
    "rec.gpsStale" to "GPS zamrożony – zostaw telefon",
    "rec.hrPassive" to "Puls pasywnie",
    "rec.gpsStaleTap" to "Dotknij, aby zamknąć",
    ...
    "rec.hrNone" to "Brak tętna – czy zegarek jest wystarczająco dociśnięty?",
    "rec.hrNoneOff" to "Brak tętna: zegarek nie rozpoczął pomiaru.",
    "rec.touchLock" to "Blokada dotyku",
    "rec.holdFree" to "2 s = dotyk wolny",
...
private fun nlTabelle(): Map<String, String> = mapOf(
    ...
    "rec.pause" to "Pauzeren",
    "rec.resume" to "Hervatten",
    ...
    "rec.gpsStale" to "GPS bevroren – laat je telefoon",
    "rec.hrPassive" to "HS passief",
    "rec.gpsStaleTap" to "Tik om te sluiten",
    ...
    "rec.hrNone" to "Geen hartslag – zit het horloge strak genoeg?",
    "rec.hrNoneOff" to "Geen hartslag: het horloge is niet gaan meten.",
    "rec.touchLock" to "Touchvergrendeling",
    "rec.holdFree" to "2 s = touch vrij",
    ...
    "f.bpm" to "bpm",
    "f.bpmVor" to "{0} geleden",
    "f.bpmKein" to "geen hartslag",
    "f.bpmAvg" to "Ø bpm",
    "f.bpmMax" to "max bpm",
    "f.time" to "Tijd",
    "f.clock" to "Klok",
...
private fun fiTabelle(): Map<String, String> = mapOf(
    ...
    "rec.gpsStale" to "GPS jumissa – jätä puhelin",
    "rec.hrPassive" to "Syke passiivinen",
    "rec.gpsStaleTap" to "Sulje napauttamalla",
    ...
    "rec.hrNone" to "Ei sykettä – onko kello tarpeeksi tiukalla?",
    "rec.hrNoneOff" to "Ei sykettä: kello ei aloittanut mittausta.",
    "rec.touchLock" to "Kosketuslukko",
    "rec.holdFree" to "2 s = kosketus auki",
    ...
    "f.kmhMax" to "maks km/h",
    "f.bpm" to "bpm",
    "f.bpmVor" to "{0} sitten",
    "f.bpmKein" to "ei sykettä",
    "f.bpmAvg" to "Ø bpm",
    "f.bpmMax" to "maks bpm",
    "f.time" to "Aika",
    "f.clock" to "Kello",
...
private fun csTabelle(): Map<String, String> = mapOf(
    ...
    "rec.pause" to "Pozastavit",
    "rec.resume" to "Pokračovat",
    ...
    "rec.gpsStale" to "GPS zamrzlé – nech telefon",
    "rec.hrPassive" to "Tep pasivně",
    "rec.gpsStaleTap" to "Klepnutím zavřít",
    ...
    "rec.hrNone" to "Žádný tep – sedí hodinky dost pevně?",
    "rec.hrNoneOff" to "Žádný tep: hodinky nezahájily měření.",
    "rec.touchLock" to "Zámek dotyku",
    "rec.holdFree" to "2 s = dotyk volný",
