...
module Strings {
    ...
    function _a1(key as Lang.String) {
        ...
        if (key.equals("rec.cancel"))     { return ["Abbrechen", "Abbräche", "Abbrechen", "Cancel", "Annuler", "Annulla", "Cancelar", "Cancelar", "Batal", "Отмена", "Annuleren", "Peruuta", "Zrušit", "Avbryt"]; }
        if (key.equals("rec.endSave"))    { return ["Ende & speichern", "Ändi & speichere", "Ende & speichern", "End & save", "Fin & enreg.", "Fine & salva", "Fin y guardar", "Fim e salvar", "Selesai & simpan", "Стоп и сохр.", "Einde & opslaan", "Lopeta & tallenna", "Konec a uložit", "Avslutt & lagre"]; }
    ...
    function _a6(key as Lang.String) {
        ...
        if (key.equals("up.uploadFirst")) { return ["erst hochladen!", "zerscht ufelade!", "erst hochladen!", "upload first!", "envoyer d'abord !", "prima caricare!", "¡subir primero!", "envie primeiro!", "unggah dulu!", "сначала загрузите!", "eerst uploaden!", "lähetä ensin!", "nejdrive nahrat!", "last opp forst!"]; }
