...
| **Teilen-Vorschau** (WhatsApp, Signal, LinkedIn, X …) | `social/og-1200x630.png` (Generator: `master/ogimage.py`), Kopie in `web/public/` | 1200×630, verlinkt als `og:image`/`twitter:image` in `web/index.html` |
