#!/usr/bin/env python3
"""Teilen-Vorschaubild (1200x630) reproduzierbar aus der Brand-Basis.

Aufruf:  ../../server/.venv/bin/python ogimage.py   (aus brand/master/)

Wozu: das Bild erscheint NICHT auf der Website, sondern in der Vorschaukarte, die WhatsApp,
Signal, Telegram, Discord, Slack, iMessage, Facebook, LinkedIn oder X bauen, wenn jemand
pumpfoil.org teilt. Bis 06.09.2026 zeigte `og:image` das quadratische Anmelde-Logo (512x512),
...
Zum Format: Vorschaukarten werden je nach Dienst auf Handybreite verkleinert. Es bleibt
deshalb nur, was auf Daumennagelgroesse noch traegt: Wortmarke, Tagline, Plattform-Liste —
und rechts der echte Screenshot, damit man sieht, dass es um Auswertung geht.
...
W, H = 1200, 630
OUT = os.path.join(os.path.dirname(__file__), "../social/og-1200x630.png")
