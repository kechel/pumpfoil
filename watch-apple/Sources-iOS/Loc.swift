...
enum Loc {
    ...
    private static let _t3: [String: [String: String]] = [
        ...
        "share.cardTitle": r("Titel (optional)", "Titel (optional)", "Titel (optional)", "Title (optional)", "Titre (optionnel)", "Titolo (facoltativo)", "Título (opcional)"),
        "share.cardTitlePlaceholder": r("z. B. Spot, Stimmung …", "z. B. Spot, Stimmig …", "z. B. Spot, Stimmung …", "e.g. spot, mood …", "p. ex. spot, ambiance …", "es. spot, atmosfera …", "p. ej. spot, ambiente …"),
        ...
        "share.color.hr": r("Puls", "Puls", "Puls", "Pulse", "Pouls", "Battito", "Pulso"),
        "share.textColor": r("Textfarbe", "Textfarb", "Textfarbe", "Text color", "Couleur du texte", "Colore testo", "Color de texto"),
        "share.shade.light": r("Hellblau", "Hellblau", "Hellblau", "Light blue", "Bleu clair", "Azzurro", "Azul claro"),
        "share.shade.dark": r("Dunkelblau", "Dunkelblau", "Dunkelblau", "Dark blue", "Bleu foncé", "Blu scuro", "Azul oscuro"),
        "share.stats": r("Statistiken", "Statistike", "Statistiken", "Stats", "Statistiques", "Statistiche", "Estadísticas"),
