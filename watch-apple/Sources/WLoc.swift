...
enum WLoc {
    ...
    private static let table: [String: [String: String]] = [
        ...
        "rec.waterLock": r("Wassersperre", "Wassersperri", "Wassersperre", "Water lock", "Verrou eau", "Blocco acqua", "Bloqueo agua"),
        ...
        "rec.discard": r("Verwerfen", "Verwärfe", "Verwerfen", "Discard", "Supprimer", "Scarta", "Descartar"),
        ...
        // Standort: ohne Freigabe keine Strecke -> die Aufnahme startet nicht (Feldbefund 05.08.).
        "rec.locPerm": r("Standort nicht erlaubt – keine Aufnahme möglich",
                         "Standort nöd erlaubt – kei Ufnahm möglich",
                         "Standort nicht erlaubt – keine Aufnahme möglich",
                         "Location not allowed – recording not possible",
                         "Localisation refusée – enregistrement impossible",
                         "Posizione non consentita – impossibile registrare",
                         "Ubicación no permitida – no se puede grabar"),
        "rec.locCoarse": r("Standort nur ungefähr – „Genau“ erlauben",
                           "Standort nur ungfähr – „Gnau“ erlaube",
                           "Standort nur ungefähr – „Genau“ erlauben",
                           "Approximate location only – allow “Precise”",
                           "Localisation approximative – autoriser « Précise »",
                           "Posizione approssimativa – consenti «Precisa»",
                           "Ubicación aproximada – permite «Precisa»"),
        "rec.keepOpen": r("App offen lassen!", "App offe lah!", "App offen lassen!", "keep app open!", "garde l'app ouverte !", "tieni aperta l'app!", "¡mantén la app abierta!"),
